...
DESCRIPTION
   ...
   OPTIONS
       ...
       Column 3
            If the field contains a numeric value it will be displayed in hex. Zip stored most numbers
            in little-endian format - the value displayed will have the little-endian encoding
            removed.
...
TODO
       Error handling is still a work in progress.  If the program encounters a problem reading a zip
