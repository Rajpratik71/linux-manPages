...
DESCRIPTION
       ...
       equivalent  of  setting  the  environment  variable LESSOPEN to '|gzip
...
BUGS
       ...
       dard input; it requires that input files be  specified  as  arguments.
       To  read  compressed  data  from  a  pipe, you can use ...|gunzip|less
       instead of ...|zless.
