...
DESCRIPTION
   ...
   Determine format of output:
       ...
       If  FILE is specified, read it to determine which colors to use for which file types and exten‐
       sions.  Otherwise, a precompiled database is used.  For details on the format of  these  files,
...
GNU coreutils 8.30                          September 2019                                DIRCOLORS(1)
