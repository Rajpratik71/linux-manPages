...
DESCRIPTION
       pydoc2.7  name Show text documentation on something.  name may be the name of a Python keyword,
       ...
       pydoc2.7  -w name [...]  Write out the HTML documentation for a module to a file in the current
