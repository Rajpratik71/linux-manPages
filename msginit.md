...
DESCRIPTION
   ...
   Output file location:
       ...
       If  no  output file is given, it depends on the --locale option or the user's locale setting.  If it is -, the results are written to stan‐
       dard output.
...
SEE ALSO
       The full documentation for msginit is maintained as a Texinfo manual.  If the info and msginit programs  are  properly  installed  at  your
       site, the command
