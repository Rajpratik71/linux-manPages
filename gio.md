...
COMMANDS
       ...
       mount [OPTION...] [LOCATION...]
           ...
           Mounting refers to the traditional concept of arranging multiple file systems and devices in a single tree, rooted at /. Classical mounting happens in the kernel and is controlle by the mount
       ...
       set LOCATION ATTRIBUTE VALUE...
           ...
           File attributes can be specified with their GIO name, e.g standard::icon. Note that not all GIO file attributes are writable. Use the --query-writable option of the info command to list writable
           file attributes.
       ...
       trash [OPTION...] [LOCATION...]
           ...
           file lives inside a users home directory, the trash folder is $XDG_DATA_HOME/Trash.
