...
OPTIONS
       ...
       -s, --supported
              Show the supported python3 versions.  List is lowest version to highest version with the
              default version last (e.g. python3.4 python3.6 python3.5 if python3.4, 3.5, and 3.6  are
              supported, but python3.5 is the default python3).
       ...
       -r, --requested [<version string>|<control file>]
              ...
              Python2 versions.  The former keyword current is not supported at all in Python3.   Uses
