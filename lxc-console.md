...
DESCRIPTION
       ...
       container specified as parameter, this command will launch a con‐
       sole allowing to log on the container.
       ...
       A ttynum of 0 may be given to attach to the container's /dev/con‐
       sole instead of its dev/tty<ttynum>.
...
OPTIONS
       ...
       -t, --tty ttynum
              ...
              If not specified the next available tty number will be au‐
              tomatically chosen by the container.
...
DIAGNOSTIC
       tty service denied
              ...
              use the console. For example, the container belongs to us‐
              er "foo" and "bar" is trying to open a console to it.
