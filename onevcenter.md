...
COMMANDS
       ·   hosts  Import  vCenter  clusters  as  OpenNebula  hosts valid
           options: vcenter, vuser, vpass

       ·   templates Import vCenter VM Templates into  OpenNebula  valid
           options: vcenter, vuser, vpass

       ·   vms  Import  vCenter running Virtual Machines into OpenNebula
           valid options: vcenter, vuser, vpass

       ·   networks  Import  vCenter  networks  into  OpenNebula   valid
           options: vcenter, vuser, vpass
