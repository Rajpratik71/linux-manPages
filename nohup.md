...
DESCRIPTION
       ...
       If  standard input is a terminal, redirect it from /dev/null.  If standard output is a terminal, append output to 'nohup.out' if possible, '$HOME/nohup.out' otherwise.  If standard error is a termi‐
       nal, redirect it to standard output.  To save output to FILE, use 'nohup COMMAND > FILE'.
...
GNU coreutils 8.22                                                                               August 2019                                                                                         NOHUP(1)
