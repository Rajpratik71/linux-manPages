...
OPTIONS
       ...
       --exclude-modules-for-implib module,module,...
           ...
           and must match exactly the filenames used by ld to open the files;
           for archive members, this is simply the member name, but for
           object files the name listed must include and match precisely any
           path used to specify the input file on the linker's command-line.
           This option is available only for the i386 PE targeted port of the
       ...
       --no-export-dynamic
           ...
           symbols to the dynamic symbol table.  The dynamic symbol table is
           the set of symbols which are visible from dynamic objects at run
           time.
       ...
       --gpsize=value
           ...
           different sections.  This is ignored for other object file
           formats.
       ...
       --library-path=searchdir
           ...
           directories.  All -L options apply to all -l options, regardless
           of the order in which the options appear.  -L options do not
           affect how ld searches for a linker script unless -T option is
           specified.

           If searchdir begins with "=" or $SYSROOT, then this prefix will be
           replaced by the sysroot prefix, controlled by the --sysroot
       ...
       -plugin name
           ...
           backward compatible, so it is sufficient to just copy in the
           newest one.
       ...
       --push-state
           ...
           When used with the --libs option all possibly needed libraries are
           listed and then possibly linked with all the time.  It is better
       ...
       --no-as-needed
           ...
           tag to only be emitted for a library that at that point in the
           link satisfies a non-weak undefined symbol reference from a
           ...
           in question do not affect whether the library is seen as needed.
       ...
       -Bsymbolic
           ...
           can also be used with the --export-dynamic option, when creating a
       ...
       --no-copy-dt-needed-entries
           ...
           command line.  Normally the linker won't add a DT_NEEDED tag to
           the output binary for each library mentioned in a DT_NEEDED tag in
       ...
       --defsym=symbol=expression
           ...
           script.  Note: there should be no white space between symbol, the
       ...
       --print-memory-usage
           ...
           of the output has one headline and one line per region.  It is
           both human readable and easily parsable by tools.  Here is an
       ...
       --no-allow-shlib-undefined
           ...
           symbols referenced in shared libraries if the linker is being used
       ...
       --no-relax
           ...
           synthesizing new instructions, selecting shorter version of
           current instructions, and combining constant values.
       ...
       --spare-dynamic-tags=count
           ...
           by post processing tools, such as the prelinker.  The default is
           5.
       ...
       --traditional-format
           ...
           no trouble).  The --traditional-format switch tells ld to not
       ...
       --section-start=sectionname=org
           ...
           values.  Note: there should be no white space between sectionname,
       ...
       --version-script=version-scriptfile
           ...
           platforms which support shared libraries; see VERSION.  It is
           ...
           marked local in the version script will not be exported.
       ...
       --reduce-memory-overheads
           ...
           O(n) algorithm which uses about 40% more memory for symbol
           storage.
       ...
       --disable-long-section-names
           ...
           on the command-line, ld will enable long section names, overriding
           the default and technically correct behaviour, when it finds the
           presence of debug information while linking an executable image
           and not stripping symbols.  [This option is valid for all PE
       ...
       --disable-stdcall-fixup
           ...
           are not printed.  If you specify --disable-stdcall-fixup, this
           feature is disabled and such mismatches are considered to be
           errors.  [This option is specific to the i386 PE targeted port of
           the linker]
       ...
       --bank-window name
           ...
           The definition of such region is then used by the linker to
       ...
       --no-ignore-branch-isa
           ...
           mode transitions.  If --ignore-branch-isa is used, then the linker
           accepts any branch relocations and any ISA mode transition
           ...
           is used a check is made causing the loss of an ISA mode transition
           to produce an error.
