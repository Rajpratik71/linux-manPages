...
DESCRIPTION
       ...
       owner) and the permissions for any domain not explicitly listed
       in subsequent entries.  The key owner always has full access
...
4.6.5                          2017-03-07              xenstore-chmod(1)
