...
OPTIONS
       --diff, -d
              If  the  $XDG_CACHE_HOME/devscripts  directory  exists,  compare the output of wnpp-alert to the previous output (cached in the file
              wnpp-diff) and output the differences.
