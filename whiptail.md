...
OPTIONS
       ...
       --default-item string
              Set   the  default item in a menu box.  Normally the first item
              in the box is the default.
       ...
       --noitem
              ...
              items specified, but checklist and radiolist  expect  only  tag
              and status.

       --notags
              Don't  display  tags  in the menu, checklist and radiolist wid‐
              gets.
       ...
       --output-fd fd
              ...
              scripts write to standard  error,  but   error   messages   may
       ...
       --yesno text height width
              ...
              the  dialog  box.  If  this string is too long to be fit in one
              line, it will be automatically divided into multiple  lines  at
              appropriate  places.  The text string may also contain the sub-
       ...
       --msgbox text height width
              ...
              sage, the user can press the ENTER key so  that  whiptail  will
       ...
       --textbox file height width
              ...
              used to scroll the text region horizontally.  For  more  conve‐
              nience,  forward and backward searching functions are also pro‐
              vided.
       ...
       --gauge text height width percent
              ...
              reflect  each  new percentage.  If stdin is XXX, the first fol‐
              lowing line is a percentage and subsequent lines up to  another
              XXX  are  used  for  a new prompt.  The gauge exits when EOF is
              reached on stdin.
...
NOTES
       ...
       the  special  argument  "--"  which means that all following arguments
