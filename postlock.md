...
DESCRIPTION
       ...
       -l lock_style
              Override the locking method specified via the mailbox_delivery_lock configuration param‐
              eter (see below).
...
DIAGNOSTICS
       The result status is 75 (EX_TEMPFAIL) when postlock(1) could not perform the  requested  opera‐
