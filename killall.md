...
OPTIONS
       ...
       -n, --ns
              Match against the PID namespace of the  given  PID.  Use  0  to
              match  against  all namespaces. The default is to match against
       ...
       -Z, --context
              ...
              expression pattern.  Must precede other arguments on  the  com‐
...
KNOWN BUGS
       ...
       line.  This figure is the size of an unsigned long  multiplied  by  8.
       For  most  32  bit  systems the limit is 32 and similarly for a 64 bit
