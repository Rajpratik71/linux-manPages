...
DESCRIPTION
       foo2slx converts Ghostscript pbmraw, bitcmyk, or pksmraw output formats to monochrome or color SLX streams, for driving the Lexmark C500 network color laser printer and other SLZ-based print‐
       ers.  The SLX stream is a variant of ZjStream produced by Software Imaging K.K.
