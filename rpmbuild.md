...
DESCRIPTION
   ...
   BUILD OPTIONS
       ...
       The  argument  used  is -b if a spec file is being used to build the package and -t if rpmbuild should look inside of a (possibly compressed) tar file for the spec file to use. After the first argu‐
       ment, the next character (STAGE) specifies the stages of building and packaging to be done and is one of:
