...
OPTIONS
       ...
       -d, --home HOME_DIR
           ...
           If the -m option is given, the contents of the current home directory will be moved to the
       ...
       -e, --expiredate EXPIRE_DATE
           ...
           This option requires a /etc/shadow file. A /etc/shadow entry will be created if there were
           none.
       ...
       -G, --groups GROUP1[,GROUP2,...[,GROUPN]]]
           ...
           If the user is currently a member of a group which is not listed, the user will be removed
           from the group. This behaviour can be changed via the -a option, which appends the user to
       ...
       -U, --unlock
           ...
           Note: if you wish to unlock the account (not only access with a password), you should also
           set the EXPIRE_DATE (for example to 99999, or to the EXPIRE value from
           /etc/default/useradd).
       ...
       -V, --del-subuids FIRST-LAST
           ...
           When both --del-subuids and --add-subuids are specified, the removal of all subordinate uid
       ...
       -W, --del-subgids FIRST-LAST
           ...
           This option may be specified multiple times to remove multiple ranges to a users account.
           When both --del-subgids and --add-subgids are specified, the removal of all subordinate gid
...
CAVEATS
       ...
       is being changed.  usermod checks this on Linux. On other platforms it only uses utmp to check
...
shadow-utils 4.5                              08/29/2019                                    USERMOD(8)
