...
CAVEATS
       ...
       changed.  usermod checks this on Linux, but only check if the user is logged in according to utmp on other architectures.
...
shadow-utils 4.2.1                                                                                05/09/2014                                                                                       USERMOD(8)
