...
DESCRIPTION
       ...
       file "input.pdf" to PostScript(tm) in "output.ps".  Normally the  out‐
       put  is  allowed  to  use  PostScript Level 2 (but not PostScript Lan‐
       guageLevel 3) constructs; the -dLanguageLevel=1 option  restricts  the
       output  to Level 1, while -dLanguageLevel=3 allows using LanguageLevel
       3 in the output.
