...
DESCRIPTION
       ...
       If  the  output  filename  is not specified, the output is placed in a
       file of the same name with a '.pdf' extension in the  current  working
       ...
       -      ps2pdf12  will  always  produce  PDF 1.2 output (Acrobat 3-and-
              later compatible).

       -      ps2pdf13 will always produce PDF  1.3  output  (Acrobat  4-and-
              later compatible).

       -      ps2pdf14  will  always  produce  PDF 1.4 output (Acrobat 5-and-
              later compatible).
...
EXAMPLES
       ...
       Converting as part of a pipe:
              ...
              make_report.pl  -t  ps  | ps2pdf -dCompatibilityLevel=1.3 - - |
              lpr
