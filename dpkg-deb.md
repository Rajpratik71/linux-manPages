...
DESCRIPTION
       ...
       read  from  standard  input  if  the archive name is given as a single
       minus character («-»); otherwise lack of support will be documented in
...
COMMANDS
       -b, --build binary-directory [archive|directory]
              ...
              and parse it. It will check the  file  for  syntax  errors  and
              other  problems,  and  display  the  name of the binary package
...
OPTIONS
       ...
       -zcompress-level
              ...
              xz and 19 for zstd).  The accepted values are 0-9 with: 0 being
              mapped to compressor none for gzip.  Before dpkg 1.16.2 level 0
