...
DESCRIPTION
       ...
       mysqlbinlog supports the following options, which can be specified on the command line or in
       ...
       To avoid problems like this, use a single mysql process to execute the contents of all binary
