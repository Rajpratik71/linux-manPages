...
DESCRIPTION
       ...
       tmac, and finally in the standard macro directory /usr/share/groff/1.22.3/tmac.  If it exists, eqn processes  it  before  the  other  input
...
USAGE
   ...
   New primitives
       ...
       vcenter e
              This  vertically  centers e about the math axis.  The math axis is the vertical position about which characters such as ‘+cq and ‘−’
...
MATHML MODE LIMITATIONS
       ...
       *      Characters that eqn over troff sets extra large – notably the integral sign – may appear too small and need to have their ‘<mstyle>’
       ...
       iters around inline equations.  They can, however, be recognized as strings that begin with ‘<math>’ and end  with  ‘</math>’  and  do  not
