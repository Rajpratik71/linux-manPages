...
OPTIONS
       ...
       -z, --zero-range
              Zeroes space in the byte range starting at offset and  continu‐
              ing  for  length bytes.  Within the specified range, blocks are
              ...
              Option --keep-size can be specified to prevent file length mod‐
              ification.
