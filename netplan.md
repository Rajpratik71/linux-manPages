   ...
   Properties for device type bonds:
       ...
       parameters (mapping)
              ...
              resend-igmp (scalar)
                     ...
                     This  parameter  specifies  how many IGMP membership reports are issued on a failover event.  Values range from 0 to 255.  0 disables sending membership reports.  Otherwise, the
