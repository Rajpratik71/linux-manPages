...
DESCRIPTION
       iptables-restore  and ip6tables-restore are used to restore IP and IPv6 Tables from data speci‐
       fied on STDIN or in file. Use I/O redirection provided by your shell to read  from  a  file  or
