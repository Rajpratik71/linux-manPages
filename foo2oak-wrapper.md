...
DESCRIPTION
       foo2oak-wrapper  is a Foomatic compatible printer wrapper for the foo2oak printer driver.  This
       script reads a Postscript ps-file or standard input and converts  it  to  Oak  Technology  OAKT
       printer  format  for  driving the HP Color LaserJet 1500 laser printer, Kyocera KM-1636/KM-2035
       copiers, and other OAKT-based printers.
...
COMMAND LINE OPTIONS
   ...
   Printer Tweaking Options
       ...
       -L mask
              Send the logical clipping values from -u/-l in the OAKT stream.  foo2oak-wrapper  always
       ...
       -z model
              Model  is  0  for  the  HP  Color  LaserJet  1500, and 1 for the Kyocera KM-1635/KM-2035
              copiers.  The default is 0.
...
EXAMPLES
       Create a monochrome OAKT stream from a Postscript document, examine it, and then print it using
       a RAW print queue:
