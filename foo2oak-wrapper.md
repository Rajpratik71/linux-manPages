...
DESCRIPTION
       foo2oak-wrapper  is  a Foomatic compatible printer wrapper for the foo2oak printer driver.  This script reads a Postscript ps-file or stan‐
       dard input and converts it to Oak Technology  OAKT  printer  format  for  driving  the  HP  Color  LaserJet  1500  laser  printer,  Kyocera
...
COMMAND LINE OPTIONS
   ...
   Printer Tweaking Options
       ...
       -L mask
              Send the logical clipping values from -u/-l in the OAKT stream.  foo2oak-wrapper always runs Ghostscript with the ideal page  dimen‐
