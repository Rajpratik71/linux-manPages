...
DESCRIPTION
       ...
       --apparent-size
              ...
              smaller, it may be larger due to holes in ('sparse') files, internal fragmentation,  in‐
              direct blocks, and the like
       ...
       --time-style=STYLE
              show times using STYLE, which can be: full-iso, long-iso, iso, or +FORMAT; FORMAT is in‐
              terpreted like in 'date'
...
PATTERNS
       ...
       ter, whereas * matches any string (composed of zero, one or multiple characters).  For example,
       *.o will match any files whose names end in .o.  Therefore, the command
