...
DESCRIPTION
       lxc-unshare  can  be used to run a task in a cloned set of names‐
       paces. This command is mainly provided for testing purposes.  De‐
       spite  its name, it always uses clone rather than unshare to cre‐
       ate the new task with fresh namespaces. Apart from testing kernel
...
EXAMPLES
       ...
       ps  output  will  show there are no other processes in the names‐
       pace.
