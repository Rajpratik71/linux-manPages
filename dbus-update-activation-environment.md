...
DESCRIPTION
       ...
       dbus-daemon's activation environment, although it might still be
...
OPTIONS
       ...
       VAR
           ...
           D-Bus services. Its value must be UTF-8 (if not, it is skipped
           with a warning). If VAR is not present in the environment, this
...
LIMITATIONS
       dbus-daemon does not provide a way to unset environment variables
