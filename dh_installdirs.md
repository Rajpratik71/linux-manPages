...
DESCRIPTION
       ...
       Many packages can get away with omitting the call to dh_installdirs completely.  Notably, other dh_* commands are expected to create
...
OPTIONS
       ...
       --create-in-sourcedir, --no-create-in-sourcedir
           Whether to create the specified directories in the source directory (usually debian/tmp) in addition to in the package build directory
       ...
       --sourcedir=dir
           ...
           Please note that this option is dependent on the --create-in-sourcedir option (when --no-create-in-sourcedir is in effect, this option
           does nothing in dh_installdirs).
...
11.3.2ubuntu1ppa-xenial2                                            2018-07-25                                                   DH_INSTALLDIRS(1)
