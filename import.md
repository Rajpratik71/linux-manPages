...
OVERVIEW
       ...
       For more information about the import command, point your browser to file:///usr/share/doc/ImageMagick-6/www/import.html or http://www.imagemagick.org/script/import.php.
...
DESCRIPTION
       ...
       By  default,  'file'  is  written in the MIFF image format.  To specify a particular image format, precede the filename with an image format name and a colon (i.e. ps:image) or specify the image
       type as the filename suffix (i.e. image.ps).  Specify 'file' as '-' for standard input or output.
