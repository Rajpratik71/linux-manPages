IPTABLES-RESTORE(8)                                                                   iptables 1.8.1                                                                  IPTABLES-RESTORE(8)
...
DESCRIPTION
       iptables-restore  and  ip6tables-restore are used to restore IP and IPv6 Tables from data specified on STDIN or in file. Use I/O redirection provided by your shell to read from a
...
iptables 1.8.1                                                                                                                                                        IPTABLES-RESTORE(8)
