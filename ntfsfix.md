...
DESCRIPTION
       ...
       You  may run ntfsfix on an NTFS volume if you think it was damaged by Windows or some other way
       and it cannot be mounted.

OPTIONS
       Below is a summary of all the options that ntfsfix accepts.  Nearly all options have two equiv‐
       ...
       -b, --clear-bad-sectors
              Clear the list of bad sectors. This is useful after cloning an old disk with bad sectors
              to a new disk.
...
AUTHORS
       ntfsfix was written by Anton Altaparmakov, with contributions from Szabolcs Szakacsits.  It was
