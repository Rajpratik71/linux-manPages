...
DESCRIPTION
       ...
       --more-than option, greater commonality may be requested before  messages  are  printed.   Con‐
       versely,  the  --less-than  option  may be used to specify less commonality before messages are
       printed (i.e.  --less-than=2 will only print the unique messages).  Translations, comments  and
       extracted comments will be preserved, but only from the first PO file to define them.  File po‐
       sitions from all PO files will be cumulated.
