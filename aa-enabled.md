AA-ENABLED(8)                                                        AppArmor                                                        AA-ENABLED(8)
...
OPTIONS
       ...
       -q, --quiet
           Do not output anything to stdout. This option is intended to be used by scripts that simply want to use the exit code to determine if
           AppArmor is enabled.
...
AppArmor 2.10.95                                                    2019-05-28                                                       AA-ENABLED(8)
