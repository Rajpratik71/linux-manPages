...
DESCRIPTION
       ...
       metadata. The metadata is acquired and updated via the 'update'
       ...
       stats
           ...
           ·   Pure virtual packages is the number of packages that exist
               ...
               Debian system is a pure virtual package; several packages
           ...
           ·   Total distinct versions is the number of package versions
               found in the cache. If more than one distribution is being
               accessed (for instance, "stable" and "unstable"), this value
               can be considerably larger than the number of total package
               names.
       ...
       search regex...
           ...
           package names and the descriptions for an occurrence of the
           ...
           package, and if --names-only is given then the long description is
           not searched, only the package name and provided packages are.
       ...
       pkgnames [prefix]
           ...
           available to download, installable or installed, e.g. virtual
           packages are also listed in the generated list.
       ...
       madison pkg...
           ...
           and a subset of the functionality of the Debian archive management
...
OPTIONS
       ...
       -q, --quiet
           ...
           of 2. You can also use -q=# to set the quietness level, overriding
       ...
       --implicit
           ...
           explicitly expressed in the metadata. With this flag it will also
           show dependencies implicitly added based on the encountered data.
           A Conflicts: foo e.g. expresses implicitly that this package also
       ...
       -a, --all-versions
           ...
           option is only applicable to the show command. Configuration Item:
       ...
       --names-only, -n
           Only search on the package and provided package names, not the
           long descriptions. Configuration Item: APT::Cache::NamesOnly.
       ...
       --with-source filename
           ...
           *.changes, Sources and Packages files as well as source package
           ...
           Note that these sources are treated as trusted (see apt-
           secure(8)). Configuration Item: APT::Sources::With.
