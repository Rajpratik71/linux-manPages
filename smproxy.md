...
DESCRIPTION
       smproxy  allows  X applications that do not support X11R6 session man‐
       agement to participate in an X11R6 session.
       ...
       WM_CLIENT_LEADER  property.   However,  this top level window contains
