...
DESCRIPTION
       lsipc  shows  information  on  the inter-process communication facilities for which the calling
...
OPTIONS
   ...
   Output formatting
       ...
       -t, --time
              ...
              on message queues, the time of the last shmat(2) and shmdt(2) operations on shared  mem‐
