...
OPTIONS
       ...
       -mname    Read in the file name.tmac.  If it isn't found, try tmac.name instead.  It will be first searched for in directories given with the -M command line option, then in directories given in the
                 GROFF_TMAC_PATH  environment  variable,  then  in  the  current  directory  (only  if  in  unsafe  mode),  the  home  directory, /usr/lib64/groff/site-tmac, /usr/share/groff/site-tmac, and
...
ENVIRONMENT
       GROFF_TMAC_PATH
              ...
              in unsafe mode, home directory, /usr/lib64/groff/site-tmac, /usr/share/groff/site-tmac, /usr/share/groff/1.22.2/tmac) after these.
       ...
       GROFF_FONT_PATH
              ...
              (/usr/share/groff/site-font, /usr/share/groff/1.22.2/font, /usr/lib/font) after these.
