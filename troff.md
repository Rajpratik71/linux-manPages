...
OPTIONS
       ...
       -mname    Read in the file name.tmac.  If it isn't found, try tmac.name instead.  It will be first searched for in directories  given  with
                 ...
                 (only   if   in   unsafe   mode),    the    home    directory,    /usr/lib/groff/site-tmac,    /usr/share/groff/site-tmac,    and
...
ENVIRONMENT
       GROFF_TMAC_PATH
              ...
              these,   and   in   standard   directories   (current  directory  if  in  unsafe  mode,  home  directory,  /usr/lib/groff/site-tmac,
              /usr/share/groff/site-tmac, /usr/share/groff/1.22.3/tmac) after these.
       ...
       GROFF_FONT_PATH
              ...
              option  before  these,  and  in standard directories (/usr/share/groff/site-font, /usr/share/groff/1.22.3/font, /usr/lib/font) after
              these.
...
COPYING
       ...
       any  later version published by the Free Software Foundation; with the Invariant Sections being this .ig-section and AUTHOR, with no Front-
...
AUTHORS
       This  file  was  originally  written  by  James  Clark,  it  was  modified  by  Werner  Lemberg  ⟨wl@gnu.org⟩  and  Bernd  Warken   ⟨groff-
