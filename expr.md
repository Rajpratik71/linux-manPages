...
DESCRIPTION
       ...
       if  both ARGs are numbers, else lexicographical.  Pattern matches return the string matched be‐
       tween \( and \) or null; if \( and \) are not  used,  they  return  the  number  of  characters
       matched or 0.
...
GNU coreutils 8.30                          September 2019                                     EXPR(1)
