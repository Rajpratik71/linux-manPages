...
DESCRIPTION
       ...
       nated by the -f option) and displays a list of  all  users  logged  in
...
OPTIONS
       ...
       -f, --file file
              ...
              --file option can be given multiple times, and all of the spec‐
              ified files will be processed.
       ...
       -s, --since time
              ...
              useful,  e.g.,  to easily determine who was logged in at a par‐
              ticular time.  The option is often combined with --until.
