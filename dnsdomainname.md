...
DESCRIPTION
   ...
   THE FQDN
       ...
       ple.com.  It is usually the hostname followed by the DNS  domain  name
       (the part after the first dot).  You can check the FQDN using hostname
       ...
       mobile  environment,  then  it  may  either have multiple FQDNs/domain
...
OPTIONS
       ...
       -A, --all-fqdns
              ...
              cannot be translated (i.e. because they do not have  an  appro‐
              priate  reverse  IP  entry)  are  skipped.  Note that different
       ...
       -i, --ip-address
              ...
              this  works  only if the host name can be resolved. Avoid using
       ...
       -I, --all-ip-addresses
              ...
              Contrary to option -i, this option does not depend on name res‐
              olution. Do not make any assumptions about  the  order  of  the
              output.
