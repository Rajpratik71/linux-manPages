econe-terminate-instances(1))-- Shutdowns a set of virtual machines (or canECONE-TERMINATE-INSTANCES(1)

NAME
       econe-terminate-instances  -  Shutdowns  a set of virtual machines (or cancel, depending on its
       state)

SYNOPSIS
       econe-terminate-instances OPTIONS INSTANCE-ID[,INSTANCE-ID...]

       Terminate the selected running instance INSTANCE-ID: The instance identification as returned by
...
LICENSE
       ...
       http://www.apache.org/licenses/LICENSE-2.0
                                              ...
                                              March 2015                  ECONE-TERMINATE-INSTANCES(1)
