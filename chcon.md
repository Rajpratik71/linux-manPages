...
DESCRIPTION
       Change  the SELinux security context of each FILE to CONTEXT.  With --reference, change the se‐
       curity context of each FILE to that of RFILE.
...
GNU coreutils 8.30                          September 2019                                    CHCON(1)
