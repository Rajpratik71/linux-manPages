...
DESCRIPTION
       ...
       Generates a bootable CD/USB/floppy image.  Arguments other than options to this program are passed to xorriso, and indicate source files, source directories, or any of the mkisofs options listed
       by the output of `xorriso -as mkisofs -help'.
...
grub-mkrescue (GRUB) 2.02~beta2-36ubuntu3.23                                                   October 2019                                                                              GRUB-MKRESCUE(1)
