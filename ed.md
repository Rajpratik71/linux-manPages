...
DDEESSCCRRIIPPTTIIOONN
       The _e_d utility is a line-oriented text editor that uses two modes:
       _c_o_m_m_a_n_d _m_o_d_e and _i_n_p_u_t _m_o_d_e.  In command mode the input characters
...
OOPPTTIIOONNSS
       ...
       −−pp  _s_t_r_i_n_g Use _s_t_r_i_n_g as the prompt string when in command mode. By
                 default, there shall be no prompt string.

       −−ss        Suppress the writing of byte counts by ee, EE, rr, and ww
...
AASSYYNNCCHHRROONNOOUUSS EEVVEENNTTSS
       ...
       ASYNCHRONOUS EVENTS section in _S_e_c_t_i_o_n _1_._4, _U_t_i_l_i_t_y _D_e_s_c_r_i_p_t_i_o_n
       _D_e_f_a_u_l_t_s) with the following exceptions:
       ...
       SIGHUP    If the buffer is not empty and has changed since the last
                 ...
                 be used. In any case, the _e_d utility shall exit without
                 writing the file to the currently remembered pathname and
...
EEXXTTEENNDDEEDD DDEESSCCRRIIPPTTIIOONN
       ...
       addresses, so that the addresses very often can be omitted. If the −−pp
   ...
   CCoommmmaannddss iinn eedd
       ...
       However, any command (except ee, EE, ff, qq, QQ, rr, ww, and !!) can be
       suffixed by the letter ll, nn, or pp; in which case, except for the ll, nn,
       and pp commands, the command shall be executed and then the new current
       line shall be written as described below under the ll, nn, and pp
       commands. When an ll, nn, or pp suffix is used with an ll, nn, or pp command,
       ...
       ppll command (base pp command with an ll suffix) shall either write just
       the current line or write it twice—once as specified for pp and once as
       specified for ll.  Also, the gg, GG, vv, and VV commands shall take a
       ...
       characters. If a suffix letter (ll, nn, or pp) is given, the application
       ...
       with the current line number unchanged. If the ee or qq command is
        ...
        *  If the _e_d utility is in command mode, it shall act as if a qq
           command had been entered.

       If the closing delimiter of an RE or of a replacement string (for
       example, ''//'') in a gg, GG, ss, vv, or VV command would be the last character
   ...
   AAppppeenndd CCoommmmaanndd
       ...
       The aa command shall read the given text and append it after the
   ...
   CChhaannggee CCoommmmaanndd
       ...
       number shall be set to zero. Address 0 shall be valid for this command;
   ...
   DDeelleettee CCoommmmaanndd
       ...
       The dd command shall delete the addressed lines from the buffer. The
   ...
   EEddiitt CCoommmmaanndd
       ...
       used (see the ff command). The number of bytes read shall be written to
       standard output, unless the −−ss option was specified, in the following
       format:


           ""%%dd\\nn"",, <<_n_u_m_b_e_r _o_f _b_y_t_e_s _r_e_a_d>

       The name _f_i_l_e shall be remembered for possible use as a default
       pathname in subsequent ee, EE, rr, and ww commands. If _f_i_l_e is replaced by
       ...
       remembered as the current _f_i_l_e.  All marks shall be discarded upon the
       completion of a successful ee command. If the buffer has changed since
   ...
   GGlloobbaall CCoommmmaanndd
       ...
       use of the gg, GG, vv, VV, and !!  commands in the _c_o_m_m_a_n_d _l_i_s_t produces
   ...
   IInntteerraaccttiivvee GGlloobbaall CCoommmmaanndd
       ...
       current invocation of GG.  Note that the commands input as part of the
       execution of the GG command can address and affect any lines in the
       ...
       executed shall be the GG command itself if a command fails or the null
       command is specified.) If there were no matching lines, the current
       line number shall not be changed. The GG command can be terminated by a
   ...
   HHeellpp CCoommmmaanndd
       ...
       The hh command shall write a short message to standard output that
   ...
   HHeellpp--MMooddee CCoommmmaanndd
       ...
       (see the hh command) shall be written to standard output for all
       subsequent ''??'' notifications. The HH command alternately shall turn this
       mode on and off; it is initially off. If the help-mode is being turned
       on, the HH command also explains the previous ''??'' notification, if there
   ...
   JJooiinn CCoommmmaanndd
       ...
       set to the address of the joined line; otherwise, the current line
   ...
   MMaarrkk CCoommmmaanndd
       ...
       The kk command shall mark the addressed line with name _x, which the
       application shall ensure is a lowercase letter from the portable
       character set. The address ""''xx"" shall then refer to this line; the
   ...
   LLiisstt CCoommmmaanndd
       ...
       Definitions volume of POSIX.1‐2008, _T_a_b_l_e _5_-_1, _E_s_c_a_p_e _S_e_q_u_e_n_c_e_s _a_n_d
       _A_s_s_o_c_i_a_t_e_d _A_c_t_i_o_n_s (''\\\\'', ''\\aa'', ''\\bb'', ''\\ff'', ''\\rr'', ''\\tt'', ''\\vv'') shall be
       written as the corresponding escape sequence; the ''\\nn'' in that table is
       not applicable. Non-printable characters not in the table shall be
   ...
   MMoovvee CCoommmmaanndd
       ...
       The mm command shall reposition the addressed lines after the line
       addressed by _a_d_d_r_e_s_s.  Address 0 shall be valid for _a_d_d_r_e_s_s and cause
       the addressed lines to be moved to the beginning of the buffer. It
       shall be an error if address _a_d_d_r_e_s_s falls within the range of moved
   ...
   NNuummbbeerr CCoommmmaanndd
       ...
       The nn command shall write to standard output the addressed lines,
       preceding each line by its line number and a <tab>; the current line
       number shall be set to the address of the last line written. The nn
       command can be appended to any command other than ee, EE, ff, qq, QQ, rr, ww,
       or !!.
   ...
   PPrriinntt CCoommmmaanndd
       ...
       written. The pp command can be appended to any command other than ee, EE,
       ff, qq, QQ, rr, ww, or !!.
   ...
   RReeaadd CCoommmmaanndd
       ...
       The rr command shall read in the file named by the pathname _f_i_l_e and
       ...
       unless there is no remembered pathname. Address 0 shall be valid for rr
   ...
   SSuubbssttiittuuttee CCoommmmaanndd
       ...
       the gg suffix. It is an error if the substitution fails on every
       ...
       reference expression. If the corresponding back-reference expression
       does not match, then the characters ''\\nn'' shall be replaced by the empty
       string. When the character ''%%'' is the only character in the
       _r_e_p_l_a_c_e_m_e_n_t, the _r_e_p_l_a_c_e_m_e_n_t used in the most recent substitute command
       shall be used as the _r_e_p_l_a_c_e_m_e_n_t in the current substitute command; if
       ...
       <backslash>.  For each <backslash> encountered in scanning _r_e_p_l_a_c_e_m_e_n_t
       ...
       application shall ensure it escapes the <newline> in the _r_e_p_l_a_c_e_m_e_n_t by
       preceding it by <backslash>.  Such substitution cannot be done as part
       of a gg or vv _c_o_m_m_a_n_d _l_i_s_t.  The current line number shall be set to the
       ...
       gg       Globally substitute for all non-overlapping instances of the RE
               rather than just the first one. If both gg and _c_o_u_n_t are
   ...
   WWrriittee CCoommmmaanndd
       ...
       −−ss option was specified, in the following format:
       ...
       considered as a ``last ww command that wrote the entire buffer'', as
       described previously; thus, this alone shall not prevent the warning to
       the user if an attempt is made to destroy the editor buffer via the ee
       or qq commands.
   ...
   SShheellll EEssccaappee CCoommmmaanndd
       ...
       previous !_c_o_m_m_a_n_d. If any replacements of ''%%'' or ''!!'' are performed, the
       modified line shall be written to the standard output before _c_o_m_m_a_n_d is
   ...
   NNuullll CCoommmmaanndd
       ...
       written. A <newline> alone shall be equivalent to ""++11pp"".  The current
...
AAPPPPLLIICCAATTIIOONN UUSSAAGGEE
       ...
       the prudent script writer begins the _e_d input commands with an HH
       ...
       described. This is no longer specified. Applications should use the −−ss
...
RRAATTIIOONNAALLEE
        ...
        *  BSD does not support the ''!!'' character part of the ee, rr, or ww
           commands.
        ...
        *  BSD does not support the PP command; moreover, in BSD it is
           synonymous with the pp command.
       ...
       The −−ss option was added to allow the functionality of the removed −−
       ...
       include a _s_p_l_i_t command in this volume of POSIX.1‐2008. Since this
       limit was removed, this volume of POSIX.1‐2008 requires that
       implementations document the file size limits imposed by _e_d in the
       ...
       the _e_x editor and is required for any line ending in <space>
       characters; the ''$$'' is placed on all lines so that a real ''$$'' at the
       ...
       Early proposals stated that the −−pp option worked only when standard
       ...
       have this restriction. The command ss//xx//XX//22004477 should be able to
       substitute the 2047th occurrence of ''xx'' on a line.
       ...
       single <period> has been to precede it with another character and then
       use the substitute command to delete that character.
       ...
       permits historical implementations of the _e_d utility on historical
       ...
       For consistency with the aa and rr commands and better user
       functionality, the ii and cc commands must also accept an address of 0,
       in which case 0_i is treated as 1_i and likewise for the cc command.
       ...
       command ""33;;//ffoooo//;;++22pp"" will display the first line after line 3 that
       contains the pattern _f_o_o, plus the next two lines. Note that the
       address ""33;;"" must still be evaluated before being discarded, because
       the search origin for the ""//ffoooo//"" command depends on this.

       Historically, _e_d disallowed address chains, as discussed above,
...
SSEEEE AALLSSOO
       ...
       _S_e_c_t_i_o_n _9_._3, _B_a_s_i_c _R_e_g_u_l_a_r _E_x_p_r_e_s_s_i_o_n_s, _C_h_a_p_t_e_r _1_1, _G_e_n_e_r_a_l _T_e_r_m_i_n_a_l
       _I_n_t_e_r_f_a_c_e, _S_e_c_t_i_o_n _1_2_._2, _U_t_i_l_i_t_y _S_y_n_t_a_x _G_u_i_d_e_l_i_n_e_s
