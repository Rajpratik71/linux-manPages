...
OPTIONS
       ...
       -o sort
           ...
           While virt-top is running you can change the sort order using keys P (cpu), M (memory), T
...
NOTES
   ...
   DEBUGGING LIBVIRT ISSUES
       ...
       To see the cause of libvirt errors in more detail, enable libvirt debugging by setting this
