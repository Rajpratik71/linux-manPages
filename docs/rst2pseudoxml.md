RST2PSEUDOXML(1)                                                  text processing                                                 RST2PSEUDOXML(1)
...
DESCRIPTION
       Generates pseudo-XML from standalone reStructuredText sources (for testing purposes).  Reads from <source> (default is stdin) and writes to
