...
SYNOPSIS
       ...
       [-o|--options [+]Field[,Field...]]  [-O|--sort [+|-]Key1[,[+|-]Key2...]]  [-P|--partial] [--rows] [--segments] [-S|--select Selection] [--separator Separator]  [--unbuffered]  [--units  hHbBsSkKmMg-
       GtTpPeE] [--unquoted] [-v|--verbose] [--version] [PhysicalVolume [PhysicalVolume...]]
...
OPTIONS
       ...
       -S, --select Selection
              ...
              list of reserved values and the set of supported selection operators, check the output of pvs -S help command.
