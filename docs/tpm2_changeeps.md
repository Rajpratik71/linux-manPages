tpm2_changeeps(1)                                             General Commands Manual                                            tpm2_changeeps(1)

NAME
       tpm2_changeeps(1) - Replaces the active platform primary seed with a new one generated off the TPM2 RNG.

SYNOPSIS
       tpm2_changeeps [OPTIONS]

DESCRIPTION
       tpm2_changeeps(1)  - Replaces the active platform primary seed with a new one generated off the TPM2 RNG.  The Transient and Persistent ob‐
