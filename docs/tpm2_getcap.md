...
DESCRIPTION
       tpm2_getcap(1)  - Query the TPM for it’s capabilities / properties and print them to the console.  It takes a string form of the capability
       to query as an argument to the tool.  Currently supported capability groups are:
...
OPTIONS
       • -l, --list:
         ...
         List known supported capability names.  These names can be supplied as the argument to the -c option.  Output is in a YAML compliant list
         to stdout.
