...
SPECIAL ESCAPES
       ...
       All  special  escapes  start  with  the escape character.  The default escape character is ^@ (octal 000); escape character can be changed with option -e, --escapes.  Escape character is followed by
