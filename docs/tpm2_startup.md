tpm2_startup(1)                                               General Commands Manual                                              tpm2_startup(1)
...
DESCRIPTION
       tpm2_startup(1) - Send a TPM2_Startup command with either TPM_SU_CLEAR or TPM_SU_STATE.
...
NOTES
       Typically a Resource Manager (like tpm2-abrmd (https://github.com/tpm2-software/tpm2-abrmd)) or low-level/boot software will  have  already
       sent this command.
