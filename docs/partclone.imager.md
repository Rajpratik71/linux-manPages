PARTCLONE.IMAGER(8)                                            Partclone User Manual                                           PARTCLONE.IMAGER(8)
...
DESCRIPTION
       partclone.imager is a part of Partclone project to clone unsupported file system with dd method. It will backup all block from partition.
...
partclone.imager                                                    09/19/2015                                                 PARTCLONE.IMAGER(8)
