...
DESCRIPTION
       ...
       For  the keyboard this means that one can attach 16-bit U+xxxx values to keyboard keys using loadkeys(1), and have these appear as UTF-8 input to user programs.  Also, that one can type hexa‐
       decimal Alt-xxxx using the numeric keypad, and again produce UTF-8.
