...
GETTING HELP
       The perldoc program gives you access to all the documentation that comes with Perl.  You can
       ...
       extensive documentation.  Run "perldoc perldoc" to learn more things you can do with perldoc.
   ...
   Stubs for Deleted Documents
       ...
       try it with perldoc.  Perldoc can also take you directly to documentation for functions (with
       the -f switch). See "perldoc --help" (or "perldoc perldoc" or "man perldoc") for other helpful
...
DESCRIPTION
       ...
       general-purpose programming language. It's widely used for everything from quick "one-liners"
       ...
       astounding array of problems.  When they haven't set the standard themselves, they steal from
       the best -- just like Perl itself.
