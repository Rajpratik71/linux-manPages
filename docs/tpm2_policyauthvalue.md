tpm2_policyauthvalue(1)                                       General Commands Manual                                      tpm2_policyauthvalue(1)
...
DESCRIPTION
       tpm2_policyauthvalue(1) - Enables a policy that requires the object’s authentication passphrase be provided.  This is equivalent to authen‐
       ticating using the object passphrase in plaintext or HMAC.  It enforces it as a policy.  It provides a mechanism to allow for password  au‐
...
EXAMPLES
       ...
       sion,  in  this  example  we  will authenticate with the plaintext passphrase in a policy session instead using the tpm2_policyauthvalue(1)
       tool.
...
tpm2-tools                                                                                                                 tpm2_policyauthvalue(1)
