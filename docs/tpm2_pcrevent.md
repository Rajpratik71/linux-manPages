tpm2_pcrevent(1)                                              General Commands Manual                                             tpm2_pcrevent(1)
...
DESCRIPTION
       ...
       Optionally, if a PCR index is specified, it extends that PCR for all supported algorithms with the hash digest.  FILE and _PCR_INDEX_ argu‐
       ments don’t need to come in any particular order.
       ...
       See sections 23.1 and sections 17 of the TPM2.0 Specification (https://trustedcomputinggroup.org/wp-content/uploads/TPM-Rev-2.0-Part-3-Com‐
       mands-01.38.pdf)
