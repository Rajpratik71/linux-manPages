...
OPTIONS
   ...
   Build-HTML Options
       ...
       --prune=<directory>
              Do not process files in <directory> (shell globbing patterns, separated by colons).  This option may be used more than once to spec‐
              ify multiple directories.  Default: ".hg:.bzr:.git:.svn:CVS".
