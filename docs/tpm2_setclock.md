tpm2_setclock(1)                                              General Commands Manual                                             tpm2_setclock(1)

NAME
       tpm2_setclock(1) - Sets the time on the TPM.

SYNOPSIS
       tpm2_setclock [OPTIONS] TIME

DESCRIPTION
       tpm2_setclock(1) - Sets the clock on the TPM to a time in the future.  The sole argument is the clock time as a number to set.
