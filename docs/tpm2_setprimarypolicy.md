tpm2_setprimarypolicy(1)                                      General Commands Manual                                     tpm2_setprimarypolicy(1)

NAME
       tpm2_setprimarypolicy(1)  -  Sets  the  authorization  policy for the lockout (lockoutPolicy), the platform hierarchy (platformPolicy), the
...
tpm2-tools                                                                                                                tpm2_setprimarypolicy(1)
