tpm2_nvextend(1)                                              General Commands Manual                                             tpm2_nvextend(1)
...
DESCRIPTION
       tpm2_nvextend(1)  -  Extend an Non-Volatile (NV) index like it was a PCR.  The NV index must be of type “extend” which is specified via the
       “nt” field when creating the NV space with tpm2_nvdefine(1).  The index can be specified as raw handle or an offset value to the NV  handle
       range “TPM2_HR_NV_INDEX” as an argument.
