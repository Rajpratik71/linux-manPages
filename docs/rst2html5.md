RST2HTML5(1)                                text processing                               RST2HTML5(1)
...
DESCRIPTION
       Generates  HTML?5  documents  from standalone reStructuredText sources Reads from <source> (de‐
...
OPTIONS
   ...
   HTML-Specific Options
       ...
       --stylesheet-path=<file[,file,...]>
              ...
              tive to the output HTML file. Default: "minimal.css,plain.css"
