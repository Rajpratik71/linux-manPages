tpm2_gettestresult(1)                                         General Commands Manual                                        tpm2_gettestresult(1)
...
DESCRIPTION
       ...
       If  pending  algorithms are scheduled to be tested, tpm2_gettestresult will return “TESTING”.  Otherwise “FAILED” will be returned or “SUC‐
       CESS” depending on the result to the test.
...
tpm2-tools                                                                                                                   tpm2_gettestresult(1)
