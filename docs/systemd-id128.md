...
DESCRIPTION
       id128 may be used to conveniently print sd-id128(3) UUIDs. What identifier is printed depends
       ...
       application-specific IDs. See sd_id128_get_machine(3) for the discussion when this is useful.
