...
DESCRIPTION
       This  tool  traces  common ZFS file operations: reads, writes, opens, and syncs. It measures the time spent in these operations, and prints
...
OVERHEAD
       ...
       Note that the overhead of this tool should be less than fileslower(8), as this tool targets zfs functions only, and not all file read/write
