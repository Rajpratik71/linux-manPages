...
DESCRIPTION
       kstats  is  a tool designed to show the FMS algorithm votes for an ivs dump (initialization vectors) with a specified WEP key. The ivs dump can be get by using the combination of
       both airodump(1) and ivstools(1).
...
Version 1.4                                                                           September 2018                                                                            KSTATS(1)
