...
DESCRIPTION
       merge_unicharsets(1) is a simple tool to merge two or more unicharsets. It could be used to
       create a combined unicharset for a script-level engine, like the new Latin or Devanagari.
...
AUTHOR
       ...
       (1985-1995) and Google (2006-present).
                                              ...
                                              04/07/2018                         MERGE_UNICHARSETS(1)
