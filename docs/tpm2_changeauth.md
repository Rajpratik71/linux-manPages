tpm2_changeauth(1)                                            General Commands Manual                                           tpm2_changeauth(1)
...
OPTIONS
       ...
       • -r, --private=FILE: The output file which contains the new sensitive portion of the object whose auth was being changed.
