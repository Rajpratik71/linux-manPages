...
DESCRIPTION
       ...
       on systems that have a zoneinfo database (the set of files describing time zones). Examples of
       such systems are Linux, FreeBSD, Solaris, and Mac OS X. One likely location for these files is
       ...
       For the first invocation syntax, pass the zoneinfo directory path name to mysql_tzinfo_to_sql
       ...
       third syntax, which initializes the leap second information.  tz_file is the name of your time
       zone file:
...
MariaDB 10.5                                 27 June 2019                        MYSQL_TZINFO_TO_S(1)
