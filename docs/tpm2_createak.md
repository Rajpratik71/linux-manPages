tpm2_createak(1)                                              General Commands Manual                                             tpm2_createak(1)

NAME
       tpm2_createak(1) - Generate attestation key with given algorithm under the endorsement hierarchy.

SYNOPSIS
       tpm2_createak [OPTIONS]

DESCRIPTION
       tpm2_createak(1)  - Generate an attestation key (AK) with the given algorithm under the endorsement hierarchy.  The context of the attesta‐
       tion key is specified via -c.
