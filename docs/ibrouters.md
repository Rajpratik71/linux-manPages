IBROUTERS(8)                                                                                  OpenIB Diagnostics                                                                                 IBROUTERS(8)
...
DESCRIPTION
       ibrouters is a script which either walks the IB subnet topology or uses an already saved topology file and extracts the router nodes.
