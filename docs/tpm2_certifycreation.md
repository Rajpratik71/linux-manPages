tpm2_certifycreation(1)                                       General Commands Manual                                      tpm2_certifycreation(1)
...
DESCRIPTION
       tpm2_certifycreation(1) - Attest the association between a loaded public area and the provided hash of the creation data.  The creation da‐
       ta and the creation ticket is produced when creating the object.  The object itself is created with either TPM2_CreatePrimary or  TPM2_Cre‐
       ate commands.
