tpm2_nvwrite(1)                                               General Commands Manual                                              tpm2_nvwrite(1)
...
DESCRIPTION
       tpm2_nvwrite(1)  -  Write data specified via FILE to a Non-Volatile (NV) index.  If FILE is not specified, it defaults to stdin.  The index
       can be specified as raw handle or an offset value to the nv handle range “TPM2_HR_NV_INDEX”.
