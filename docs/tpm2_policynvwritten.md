...
DESCRIPTION
       tpm2_policynvwritten(1)  -  Restricts TPM object authorization to the written state of an NV index.  Useful when creating write once NV in‐
       dexes.
...
EXAMPLES
       Create  a  write  once  NV index.  To do this the NV index is defined with a write policy that is valid only if the NV index attribute “TP‐
...
tpm2-tools                                                                                                                 tpm2_policynvwritten(1)
