UNIXTERM(1)                                                   General Commands Manual                                                  UNIXTERM(1)
...
DESCRIPTION
       A unixterm is a terminal application for a unix stream socket.
...
Virtual Distributed Ethernet                                     December 6, 2006                                                      UNIXTERM(1)
