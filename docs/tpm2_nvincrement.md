tpm2_nvincrement(1)                                           General Commands Manual                                          tpm2_nvincrement(1)
...
DESCRIPTION
       tpm2_nvincrement(1) - Increment value of a Non-Volatile (NV) index setup as a counter.  The index can be specified as raw handle or an off‐
       set value to the nv handle range “TPM2_HR_NV_INDEX”.
