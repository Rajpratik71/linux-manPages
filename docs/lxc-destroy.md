...
OPTIONS
       -f, --force
              If  a container is running, stop it first. If this option is not specified and the con‐
              tainer is running, then lxc-destroy will be aborted.
...
DIAGNOSTIC
       The container was not found
              The  specified  container for destruction was not found. It is probable it does not ex‐
              ists and was already destroyed.You can use the lxc-ls command  to  list  the  available
