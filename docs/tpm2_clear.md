tpm2_clear(1)                                                 General Commands Manual                                                tpm2_clear(1)
...
DESCRIPTION
       tpm2_clear(1) - Send a clear command to the TPM to clear the 3 hierarchy authorization values.  As an argument takes the auth value for ei‐
       ther platform or lockout hierarchy
