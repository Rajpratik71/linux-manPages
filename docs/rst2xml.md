RST2XML(1)                                                        text processing                                                       RST2XML(1)
...
DESCRIPTION
       Generates Docutils-native XML from standalone reStructuredText sources.  Reads from <source> (default is stdin) and writes to <destination>
