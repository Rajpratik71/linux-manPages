SET_UNICHARSET_PROPE(1)                                                       SET_UNICHARSET_PROPE(1)
...
DESCRIPTION
       set_unicharset_properties(1) reads a unicharset file, puts the result in a UNICHARSET object,
       fills it with properties about the unichars it contains and writes the result back to another
       unicharset file.

OPTIONS
       --script_dir /path/to/langdata
           (Input) Specify the location of directory for universal script unicharsets and font
...
AUTHOR
       ...
       (1985-1995) and Google (2006-present).
                                              ...
                                              04/07/2018                      SET_UNICHARSET_PROPE(1)
