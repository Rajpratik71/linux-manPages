CRSH(1p)                                                User Contributed Perl Documentation                                               CRSH(1p)

NAME
       crsh - Cluster administration tool

SYNOPSIS
       crsh [-a '<command>'] [-K <seconds>] [-q] [-c '<filename>'] [-C '<filename>'] [--debug [[...] || <INTEGER>]] [-d] [-e
...
DESCRIPTION
   ...
   Further Notes
       ...
       ·   If client windows fail to open, try running:
           ...
           documentation) or the configuration of "rsh".
...
perl v5.20.2                                                        2015-12-04                                                            CRSH(1p)
