...
NAME
       tpm2_makecredential(1) - Load an object that is not a Protected Object into the TPM.

SYNOPSIS
       tpm2_makecredential [OPTIONS]

DESCRIPTION
       tpm2_makecredential(1)  -  Use  a  TPM public key to protect a secret that is used to encrypt the attestation key certificate.  This can be
       used without a TPM by using the none TCTI option.
...
OPTIONS
       ...
       • -o, --credential-blob=FILE:
         ...
         The output file path, recording the two structures output by tpm2_makecredential function.
...
tpm2-tools                                                                                                                  tpm2_makecredential(1)
