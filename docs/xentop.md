...
SYNOPSIS
       xentop [-h] [-V] [-dSECONDS] [-n] [-r] [-v] [-f] [-b] [-iITERATIONS]

DESCRIPTION
       xentop displays information about the Xen system and domains, in a continually-updating manner.
       Command-line options and interactive commands can change the detail and format of the
