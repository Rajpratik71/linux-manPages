tpm2_policytemplate(1)                                        General Commands Manual                                       tpm2_policytemplate(1)

NAME
       tpm2_policytemplate(1) - Couples a policy with public template data digest of an object.

SYNOPSIS
       tpm2_policytemplate [OPTIONS]

DESCRIPTION
       tpm2_policytemplate(1)  -  Couples  a policy with public template data digest of an object.  This is a deferred assertion where the hash of
       the public template data of an object is checked against the one specified in the policy.
...
tpm2-tools                                                                                                                  tpm2_policytemplate(1)
