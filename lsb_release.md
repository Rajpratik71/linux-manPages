...
OPTIONS
       ...
       -s, --short
              Use the short output format for any information displayed.  This format omits the  lead‐
              ing header(s).
...
NOTES
       ...
       earliest distribution which is still being used by apt but that heuristic is subject to error.
