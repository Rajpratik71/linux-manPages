...
DESCRIPTION
       ...
       Traditional  GNU  screen(1)  uses ctrl-a as its escape character, while GNU emacs(1) uses ctrl-a to move the cursor to the beginning of the
       line.  This conflict has caused unending amounts of grief among Screen, Byobu, and Emacs-mode users.
