...
DESCRIPTION
       ...
       can use the -noantialias flag.  This does the shearing by moving  pix‐
       els  without  changing  their  values.   If you want anti-aliasing and
       don't care about the precise colors, but still need a limited *number*
       of colors, you can run the result through ppmquant.
