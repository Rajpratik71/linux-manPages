...
OVERVIEW
       The  display-im6.q16 program is a member of the ImageMagick-ims6.q16(1) suite of tools.  Use it
       ...
       file:///usr/share/doc/imagemagick-6-common/html/www/display.html  (on debian system you may in‐
       stall the imagemagick-6 package) or https://www.imagemagick.org/script/display.php.
...
DESCRIPTION
       ...
       options:   -background, -bordercolor, -borderwidth, -font, -foreground, -iconGeometry, -iconic,
...
NOTE
       The  display  program  defaults to the X screen resolution.  To display vector formats at their
       intended size, override the default resolution:
...
COPYRIGHT
       Copyright (C) 1999-2018 ImageMagick Studio LLC. Additional copyrights  and  licenses  apply  to
