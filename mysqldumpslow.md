...
DESCRIPTION
       The MySQL slow query log contains information about queries that take a long time to execute (see Section 5.4.5, “The Slow Query Log”).
       ...
       these values to N and 'S' when displaying summary output. To modify value abstracting behavior, use the -a and -n options.
...
MySQL 5.7                                                           06/08/2019                                                    MYSQLDUMPSLOW(1)
