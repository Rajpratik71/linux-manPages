...
DESCRIPTION
   ...
   Output file location in Java mode:
       ...
       an  underscore.   The  -d option is mandatory.  The class is written under the specified direc‐
       tory.
   ...
   Output file location in C# mode:
       ...
       The -l and -d options are mandatory.  The .dll file is written in a subdirectory of the  speci‐
