...
DESCRIPTION
       ...
       tered by setting an environment variable.  Commands are based on both more(1) and vi(1) and al‐
       low back and forth movement and searching.  See the less(1) manual for more information.
...
ENVIRONMENT
       ...
       LESSOPEN
              Set to a command line to invoke the xz(1) decompressor for preprocessing the input files
              to less(1).
