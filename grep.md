...
OPTIONS
   ...
   Matching Control
       -e PATTERNS, --regexp=PATTERNS
              Use PATTERNS as the patterns.  If this option is used multiple times or is combined with
...
REGULAR EXPRESSIONS
   ...
   Character Classes and Bracket Expressions
       ...
       character not in the list; it is  unspecified  whether  it  matches  an  encoding  error.   For
...
BUGS
   ...
   Known Bugs
       Large repetition counts in the {n,m} construct may cause grep to use lots of memory.  In  addi‐
       tion,  certain  other  obscure  regular expressions require exponential time and space, and may
