...
COMMANDS
       -l, --list [package-name-pattern...]
              ...
              pattern  is  given,  list all packages in /var/lib/dpkg/status,
              excluding the ones marked as not-installed  (i.e.  those  which
              have  been previously purged). Normal shell wildcard characters
              are allowed  in  package-name-pattern.  Please  note  you  will
              probably  have  to  quote  package-name-pattern  to prevent the
              shell from performing filename expansion. For example this will
       ...
       -c, --control-path package-name [control-file]
              ...
              needed (i.e. when having to remove a damaging postrm maintainer
              script), and while there is no good  solution  for  that,  this
       ...
       -S, --search filename-search-pattern...
              ...
              of ‘*[?/’ then it will be considered a substring match and will
              be  implicitly  surrounded  by  ‘*’  (as  in  *filename-search-
...
OPTIONS
       ...
       -f, --showformat=format
              ...
              The  following  fields  are  recognized  but   they   are   not
