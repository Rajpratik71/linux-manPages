...
DESCRIPTION
       ...
       were written, or if the primary superblock is damaged, eg. accidentally overwritten.
       ...
       To dump a superblock use the btrfs inspect-internal dump-super command, or the obsolete command btrfs-show-super.
