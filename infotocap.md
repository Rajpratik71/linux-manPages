...
DESCRIPTION
       infotocap  looks in each given text file for terminfo descriptions.  For each terminfo descrip‐
       tion found, an equivalent termcap description is written to standard output.  Terminfo use  ca‐
       pabilities are translated directly to termcap tc capabilities.
...
NOTES
       This utility is actually a link to tic, running in -C mode.  You can use other tic options such
       as -f and  -x.
