...
OPTIONS
       ...
       -c, --colon-separate
              Separate  info  about  each user with a colon instead of a new‐
              line.
       ...
       -u, --user-accs
              ...
              nfsnobody (UID 65534).  This hardcoded default maybe  overwrit‐
              ten   by   parameters   UID_MIN   and   UID_MAX   in  the  file
              /etc/login.defs.
       ...
       -z, --print0
              Delimit user entries with a nul character, instead  of  a  new‐
              line.
...
AVAILABILITY
       The lslogins command is part of the util-linux package and  is  avail‐
