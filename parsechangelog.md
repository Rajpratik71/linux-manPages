...
NAME
       parsechangelog - parse Debian changelogs and output them in other
       formats
...
SYNOPSIS
       ...
       debian/changelog will be used. If two different files are specified
       ...
       "--since" and "--from" and one of "--until" and "--to" can be
...
DESCRIPTION
       ...
       policy (version 3.9.8 at the time of this writing) and converts them
       ...
       xml Just a simple XML dump of the changelog data. Without any schema
           or DTD currently, just some made up XML. The actual format might
       ...
       html
           ...
           specifically designed to be used on <http://packages.debian.org/>.
...
BUGS
       Any version given with "--since", "--until", "--from", or "--to" must
       exist in the changelogfile, else parsechangelog will a wrong result or
       even abort with an error message. See <https://bugs.debian.org/576606>
