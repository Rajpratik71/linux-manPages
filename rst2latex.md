...
DESCRIPTION
       Generates  LaTeX  documents  from standalone reStructuredText sources. Reads from <source> (de‐
...
OPTIONS
   ...
   LaTeX-Specific Options
       ...
       System Message: WARNING/2 (debian/tmp/man/rst2latex.txt:, line 180)
       ...
       --latex-preamble=LATEX_PREAMBLE
              Customization  by LaTeX code in the preamble. Default: select PDF standard fonts (Times,
              Helvetica, Courier).
       ...
       --font-encoding=FONT_ENCODING
              LaTeX  font  encoding.  Possible  values  are "", "T1" (default), "OT1", "LGR,T1" or any
              other combination of options to the fontenc package.
