...
DESCRIPTION
       ...
       7zr is a stand-alone executable.  7zr is a "light-version" of 7za(1).   7zr  handles  password-
       less archives in the 7z, LZMA2, and XZ formats only.
...
SWITCHES
       ...
       -m{Parameters}
              Set  Compression Method (see /usr/share/doc/p7zip/DOC/MANUAL/cmdline/switches/method.htm
...
DIAGNOSTICS
       7-Zip returns the following exit codes:
              ...
              1      Warning (Non fatal error(s)). For example, some files cannot be read during  com‐
                     pressing, so they were not compressed
...
EXAMPLE 2
       7zr a -sfx archive.exe dir1
              add  all  files  from  directory "dir1" to SFX archive archive.exe (Remark : SFX archive
              MUST end with ".exe")
