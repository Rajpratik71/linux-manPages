...
DESCRIPTION
   ...
   Choice of input file language:
       -L, --language=NAME
              ...
              GCC-source, NXStringTable, RST, Glade, Lua, JavaScript, Vala, Desktop)
   ...
   Language specific options:
       -a, --extract-all
              extract all strings (only languages C, C++, ObjectiveC, Shell, Python, Lisp,  EmacsLisp,
              librep, Scheme, Java, C#, awk, Tcl, Perl, PHP, GCC-source, Glade, Lua, JavaScript, Vala)

       -kWORD, --keyword=WORD
              look for WORD as an additional keyword

       -k, --keyword
              do  not to use default keywords (only languages C, C++, ObjectiveC, Shell, Python, Lisp,
              EmacsLisp, librep, Scheme, Java, C#, awk, Tcl, Perl, PHP, GCC-source, Glade, Lua,  Java‐
              Script, Vala, Desktop)
...
COPYRIGHT
       Copyright  ©  1995-1998, 2000-2016 Free Software Foundation, Inc.  License GPLv3+: GNU GPL ver‐
...
GNU gettext-tools 0.19.8.1                   November 2018                                 XGETTEXT(1)
