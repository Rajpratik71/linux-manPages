...
OPTIONS
       ...
       -Z, --context
              ...
              For netlink(7) sockets the initiating process context is displayed as follows:
                     ...
                     3.  If a unique identifier has been allocated by the kernel or netlink user, show context as "unavailable". This will  gener‐
...
STATE-FILTER
       STATE-FILTER allows to construct arbitrary set of states to match. Its syntax is sequence of keywords state and exclude followed by identi‐
       fier of state.
