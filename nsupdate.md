...
DESCRIPTION
       ...
       would be added to /etc/named.conf so that the name server can
       associate the appropriate secret key and algorithm with the IP address
       of the client application that will be using TSIG authentication. You
       can use ddns-confgen to generate suitable configuration fragments.
...
OPTIONS
       ...
       -P
           Print the list of private BIND-specific resource record types
       ...
       -y [hmac:]keyname:secret
           ...
           may be visible in the output from ps(1) or in a history file
...
COPYRIGHT
       Copyright © 2000-2012, 2014-2017 Internet Systems Consortium, Inc.
       ("ISC")
