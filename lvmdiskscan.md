...
DESCRIPTION
       lvmdiskscan  scans  all  SCSI,  (E)IDE  disks,  multiple  devices  and a bunch of other block devices in the system looking for LVM PVs. The size reported is the real device size. Define a filter in
...
Red Hat, Inc.                                                                      LVM TOOLS 2.02.185(2)-RHEL7 (2019-05-13)                                                                    LVMDISKSCAN(8)
