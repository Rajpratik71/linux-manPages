...
OPTIONS
   Generic build options
       ...
       -Tsubstvars-file
              ...
              to not read any file. This option can be used multiple times to
       ...
       --extend-diff-ignore=regex
              ...
              (since dpkg 1.15.6).  It does this by concatenating “|regex” to
              the  existing  value.   This  option  is  convenient  to use in
       ...
       The  exact semantic of tar's --exclude option is somewhat complicated,
       see https://www.gnu.org/software/tar/manual/tar.html#wildcards  for  a
       full documentation.
...
SOURCE PACKAGE FORMATS
   ...
   Format: 1.0
       ...
       -sk    Specifies to expect  the  original  source  as  a  tarfile,  by
              ...
              leave this original source in place as a tarfile, or copy it to
              the  current  directory  if it isn't already there. The tarball
              will be unpacked into directory.orig for the generation of  the
              diff.
       ...
       -sn    Specifies  to  not  look  for  any  original source, and to not
              ...
              empty  string.  This is used for Debian-specific packages which
              do not have a separate upstream source and  therefore  have  no
              debianization diffs.
       ...
       -sa or -sA
              ...
              tarfile is found it will unpack  it  to  create  the  diff  and
              remove  it  afterwards  (this  is  equivalent  to  -sp);  if  a
              directory is found it will  pack  it  to  create  the  original
              source and remove it afterwards (this is equivalent to -sr); if
              neither is found  it  will  assume  that  the  package  has  no
   ...
   Format: 3.0 (quilt)
       ...
       and the latter one doesn't exist (or is a symlink), then the latter is
       ...
       --create-empty-orig
              ...
              package is just a bundle  of  multiple  upstream  software  and
              where there's no “main” software.
...
DIAGNOSTICS
   no source format specified in debian/source/format
       ...
       you should be explicit about it and put “1.0” in debian/source/format.
...
FILES
   ...
   debian/source/options
       ...
       the ‘=’ symbol and optional  quotes  are  allowed  around  the  value.
