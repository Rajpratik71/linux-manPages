...
OPTIONS
       ...
       provided. Mandatory or optional arguments to long options are mandato‐
       ry or optional for short options, too. Both short and long options are
       case sensitive.
       ...
       -o[name], --output=[name]
              ...
              .ppm  or  .pgm. In case of video streams, the frames are stored
              in the files name.N.ppm where N is the  frame  number  (of  the
              form  00..0 - 99..9); output on the standard output is not pos‐
              sible with video streams.
              ...
              this  list.  Otherwise,  the current directory is used to store
              the output file(s).

       -z, --fast
              Decompress images in the 4:2:0 format; i.e., each chroma  chan‐
              nel is decompressed to an image of halved width and height. Use
       ...
       -d, --double
              ...
              pixel interpolation is used, each pixel  is  just  replaced  by
       ...
       -m N, --magnify=N
              ...
              enlarge  and  negative values reduce the image width and height
              by a factor of 2^|N|.
...
EXAMPLES
       ...
       fiascotopnm -o foo1.wfa foo2.wfa
              ...
              the   frames   to   the   image   files   "foo1.wfa.ppm"    and
              "foo2.wfa.ppm".
       ...
       fiascotopnm --fast --magnify=-1 --double video.wfa >stream.ppm
              ...
              speed  is  as  fast  as possible: the image is decompressed (in
              4:2:0 format) at a quarter of its original size; then the image
