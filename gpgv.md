...
DESCRIPTION
       ...
       By default a keyring named ‘trustedkeys.gpg’ is used.  This default keyring is assumed to be in the home directory of GnuPG, either the default home directory or the one set by an option  or  an
       environment variable.  The option --keyring may be used to specify a different keyring or even multiple keyrings.
...
OPTIONS
       ...
       --weak-digest name
              ...
              be considered weak.  MD5 is always considered weak, and does not need to be listed explicitly.
...
GnuPG 1.4.20                                                                                    2018-08-06                                                                                        GPGV(1)
