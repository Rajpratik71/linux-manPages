...
DESCRIPTION
       vgremove  removes  one  or more VGs. If LVs exist in the VG, a prompt is used to confirm LV re‐
       moval.

       If one or more PVs in the VG are lost, consider vgreduce --removemissing to make the  VG  meta‐
