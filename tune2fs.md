...
SYNOPSIS
       ...
       -i  interval-between-checks  ] [ -I new_inode_size ] [ -j ] [ -J jour‐
       nal-options  ]  [  -m  reserved-blocks-percentage  ]  [  -o  [^]mount-
...
OPTIONS
       -c max-mount-counts
              ...
              unanticipated  long  reboots  while e2fsck does its work.  How‐
              ever, you may wish to consider the  consequences  of  disabling
       ...
       -E extended-options
              ...
              ('=') sign.  The following extended options are supported:
                   ...
                   stride=stride-size
                          ...
                          hurt the performance.  It may also be used by block
                          allocator.
       ...
       -f     Force the tune2fs operation to complete even  in  the  face  of
              ...
              nal journal), but that external journal is not available.    If
              the  filesystem  appears to require journal replay, the -f flag
       ...
       -i  interval-between-checks[d|m|w]
              ...
              days, m as months, and w as weeks.  A value of zero  will  dis‐
              able the time-dependent checking.

              There are pros and cons to disabling these periodic checks; see
              the  discussion  under  the  -c  (mount-count-dependent  check)
              option for details.
       ...
       -j     Add an ext3 journal to the filesystem.  If the -J option is not
              ...
              way to  create  the  journal  inode  while  the  filesystem  is
              ...
              unmounted filesystems, e2fsck(8) will automatically move .jour‐
              nal  files  to  the invisible, reserved journal inode.  For all
              filesystems except for the root filesystem,  this should happen
              automatically  and  naturally  during  the  next  reboot cycle.
              Since the root filesystem is mounted read-only, e2fsck(8)  must
       ...
       -m reserved-blocks-percentage
              Set the percentage of the filesystem which may  only  be  allo‐
              cated  by  privileged  processes.    Reserving  some  number of
       ...
       -o [^]mount-option[,...]
              ...
              tune2fs:
                   ...
                   nobarrier
                          ...
                          tions  in  the  journal  disabled.  (This option is
                   ...
                   nodelalloc
                          ...
                          mount  option.  This will disable the delayed allo‐
                          cation feature.  (This  option  is  currently  only
                          supported by the ext4 file system driver in 2.6.35+
                          kernels.)
       ...
       -O [^]feature[,...]
              ...
              tune2fs:
                   ...
                   extent Enable  the  use of extent trees to store the loca‐
                          tion of data blocks in inodes.   Tune2fs  currently
                   ...
                   flex_bg
                          ...
                          will  not  reorganize  the  location  of  the inode
                          tables and allocation bitmaps, as mke2fs(8) will do
                          when  it  creates  a  freshly formatted file system
                   ...
                   sparse_super
                          ...
                          space on large filesystems.  Tune2fs currently only
              ...
              In particular, the uninit_bg and flex_bg features are only sup‐
       ...
       -T time-last-checked
              ...
              clean, then this option can be used to  set  the  last  checked
              time  on  the  original  filesystem.   The format of time-last-
              checked is the international date format, with an optional time
              specifier,  i.e.   YYYYMMDD[HH[MM[SS]]].    The  keyword now is
