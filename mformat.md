...
Description
       The  mformat  command  is  used to add an MS-DOS file system to a low-
...
Options
       ...
       f      Specifies the size of the DOS file system  to  format.  Only  a
              ...
              for others use the -h/-t/-s flags. The following sizes are sup‐
              ported:
       ...
       C      creates  the  disk image file to install the MS-DOS file system
              on it. Obviously, this is useless on physical devices  such  as
       ...
       r      Sets the size of the root directory (in sectors).  Only  appli‐
              cable to 12 and 16 bit FATs. This setting can also be specified
