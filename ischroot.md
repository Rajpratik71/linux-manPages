...
DESCRIPTION
       ...
       2      if  the detection is not possible (On GNU/Linux this happens if the script is not run as
              root).
...
BUGS
       On GNU/Linux, chroot detection is not possible when not root. This works correctly on  GNU/Hurd
       and GNU/kFreeBSD.
