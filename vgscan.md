...
OPTIONS
       ...
       --mknodes
              Also checks the LVM special files in /dev that are needed for active LVs and creates any
       ...
       --notifydbus
              ...
              with support for D-Bus notification, or if the notify_dbus config setting is disabled.
