...
DESCRIPTION
       ...
       gnome-software allows you to add and remove applications and
       update your system.
...
OPTIONS
       ...
       --mode MODE
           Starts gnome-software in the given mode.  MODE can be
           'updates', 'updated', 'installed' or 'overview'. The default
           mode is 'overview'.
