...
DESCRIPTION
       ...
       Note:  if  you're  running a Debian kernel, be sure that the msr.ko kernel module is loaded. 'modprobe msr' should do the trick. Otherwise, you'll get an error about wrmsr not being able to open
       files in /dev/cpu/...
