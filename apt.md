...
DESCRIPTION
       ...
       update (apt-get(8))
           ...
           operate on this data to e.g. perform package upgrades or search in and display details
       ...
       upgrade (apt-get(8))
           ...
           upgrade for a package requires the remove of an installed package the upgrade for this
       ...
       install, remove, purge (apt-get(8))
           ...
           exact match. The requested action can be overridden for specific packages by append a plus
           ...
           name with an equals (=) and the version of the package to select. Alternatively the version
           from a specific release can be selected by following the package name with a forward slash
           (/) and codename (stretch, buster, sid ...) or suite name (stable, testing, unstable). This
           will also select versions from this release for dependencies of this package if needed to
           satisfy the request.
       ...
       autoremove (apt-get(8))
           ...
           dependencies for other packages and are now no longer needed as dependencies changed or the
       ...
       edit-sources (work-in-progress)
           edit-sources lets you edit your sources.list(5) files in your preferred texteditor while
...
APT 1.6.12                                  20 October 2015                                     APT(8)
