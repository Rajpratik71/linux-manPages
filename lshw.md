...
DESCRIPTION
       ...
       chine. It can report exact memory configuration, firmware version, mainboard configuration, CPU
       version and speed, cache configuration, bus speed, etc. on DMI-capable x86 or IA-64 systems and
       ...
       -disable test
              ...
              (for PCMCIA/PCCARD), ide (for IDE/ATAPI), usb (for USB devices),scsi (for SCSI) or  net‐
