...
DESCRIPTION
       ...
       the command line.  These notifications can be used to inform the user about an event or display
...
OPTIONS
       ...
       -t, --expire-time=TIME
              The  duration, in milliseconds, for the notification to appear on screen.  (Ubuntu's No‐
              tify OSD and GNOME Shell both ignore this parameter.)
...
AUTHOR
       ...
       Paul  van  Tilburg  <paulvt@debian.org>  and Riccardo Setti <giskard@debian.org> for the Debian
