...
OPTIONS
       ...
       -i name, --input-name=name
              ...
              read Standard Input.  name has to be either an  image  filename
              or a template of the form:
              ...
              files in the current directory  and  in  the  (colon-separated)
       ...
       -b name, --basis-name=name
              ...
              vides the initial compression dictionary.  Either  use  one  of
       ...
       -t N, --tiling-exponent=N
              ...
              i.e.  the  image  is  subdivided  into 16 tiles. The processing
       ...
       -p type, --pattern=type
              ...
              defines the type of predicting which should be used  for  frame
              N; the frame type pattern is periodically extended. Valid char‐
              acters are:
       ...
       --B-as-past-ref
              Also use previously encoded B-frames when prediction  the  cur‐
              rent frame. If this option is not set, only I- and P-frames are
...
EXAMPLES
       ...
       pnmtofiasco -2 -p "IBBPBBPBB" -fps 15 -o video.wfa foo0*.ppm
              ...
              predict P-frame 4, frames 1 and 4 are used to predict  B-frames
              2 and 3, and so on. Frame 10 is again an intra-frame.
