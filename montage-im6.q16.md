montage-im6.q16(1)                      General Commands Manual                     montage-im6.q16(1)

NAME
       montage  -  create a composite image by combining several separate images. The images are tiled
...
OVERVIEW
       The montage-im6.q16 program is a member of the ImageMagick-ims6.q16(1) suite of tools.  Use  it
       to  create  a composite image by combining several separate images. The images are tiled on the
       ...
       file:///usr/share/doc/imagemagick-6-common/html/www/montage.html  (on debian system you may in‐
       stall the imagemagick-6 package) or https://www.imagemagick.org/script/montage.php.
...
DESCRIPTION
       ...
       In addition to those listed above, you can specify these standard X resources as  command  line
       options:  -background, -bordercolor, -borderwidth, -font, -mattecolor, or -title.
