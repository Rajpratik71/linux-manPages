...
DESCRIPTION
       ...
       constants, functions and modules.  Finally, the Python Reference  Man‐
       ual  describes  the syntax and semantics of the core language in (per‐
...
COMMAND LINE OPTIONS
       ...
       -I     Run Python in isolated mode. This also implies -E  and  -s.  In
              ...
              variables  are  ignored,  too.   Further  restrictions  may  be
       ...
       -W argument
              ...
              such  as  inside a loop); module to print each warning only the
...
ENVIRONMENT VARIABLES
       PYTHONHOME
              ...
              fix}/lib/python<version>   and   ${exec_prefix}/lib/python<ver‐
              sion>,  where  ${prefix}  and  ${exec_prefix} are installation-
       ...
       PYTHONPATH
              ...
              sion> (see PYTHONHOME  above).   The  default  search  path  is
       ...
       PYTHONIOENCODING
              ...
              same meaning as in str.encode. For stderr, the errorhandler
               part  is  ignored;  the  handler  will always be ´backslashre‐
              place´.
