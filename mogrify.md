mogrify-im6.q16(1)                      General Commands Manual                     mogrify-im6.q16(1)

NAME
       mogrify  -  resize an image, blur, crop, despeckle, dither, draw on, flip, join, re-sample, and
       much more. Mogrify overwrites the original image file, whereas, convert-im6.q16(1) writes to  a
...
OVERVIEW
       The  mogrify-im6.q16 program is a member of the ImageMagick-ims6.q16(1) suite of tools.  Use it
       to resize an image, blur, crop, despeckle, dither, draw on, flip,  join,  re-sample,  and  much
       more.  This tool is similar to convert-im6.q16(1) except the original image file is overwritten
       with any changes you request.

       For   more   information   about   the    mogrify    command,    point    your    browser    to
       file:///usr/share/doc/imagemagick-6-common/html/www/mogrify.html  (on debian system you may in‐
       stall the imagemagick-6 package) or https://www.imagemagick.org/script/mogrify.php.
