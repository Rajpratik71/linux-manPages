...
OVERVIEW
       The  mogrify-im6.q16  program is a member of the ImageMagick-ims6.q16(1) suite of tools.  Use it to resize an image, blur, crop, despeckle, dither, draw on, flip, join, re-sample, and much more. This tool is similar to convert-im6.q16(1) except the original image file is overwritten with any changes you
       request.
