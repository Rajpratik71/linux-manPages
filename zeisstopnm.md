...
DESCRIPTION
       Reads  a  Zeiss confocal file as input.  Produces a portable anymap as output.  The type of the output file depends on the input file - if it's grayscale a pgm file, else a ppm file will be pro‐
       duced.  The program tells you which type it is writing.
