...
DESCRIPTION
   ...
   Input file location in Java mode:
       ...
       The  class name is determined by appending the locale name to the resource name, separated with
       an underscore.  The class is located using the CLASSPATH.
   ...
   Input file location in C# mode:
       ...
       The -l and -d options are mandatory.  The .dll file is located in a subdirectory of the  speci‐
       fied directory whose name depends on the locale.
...
SEE ALSO
       The full documentation for msgunfmt is maintained as a Texinfo manual.  If  the  info  and  ms‐
