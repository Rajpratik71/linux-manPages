...
OPTIONS
       ...
       All  other  options  change one of the parameters that are used to derive the heights and depths.  Like the existing quantities in the font
       file, each value is in inches/res for a font whose point size is unitwidth.  param-option must be one of:
...
Groff Version 1.22.3                                              28 January 2016                                                     ADDFTINFO(1)
