...
DESCRIPTION
       ...
       Since interdiff doesn't have the advantage of being able to look at
...
BUGS
       ...
       caveats. If you find a bug, please report it (along with a minimal
       test case) to Tim Waugh <twaugh@redhat.com>.
