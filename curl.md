...
URL
       ...
       the shell from interfering with it. This also goes for  other  charac‐
       ters treated special, like for example '&', '?' and '*'.
...
PROGRESS METER
       ...
       it disables the progress meter as otherwise it would mess up the  out‐
       put mixing progress meter and response data.
...
OPTIONS
       ...
       --anyauth
              ...
              support. This is done by first doing a request and checking the
              response-headers,  thus  possibly  inducing  an  extra  network
              round-trip. This is used instead of setting a specific  authen‐
              tication  method,  which  you  can  do  with --basic, --digest,
              --ntlm, and --negotiate.
       ...
       --cert-type <type>
              ...
              is in. PEM, DER and ENG are recognized types.   If  not  speci‐
              fied, PEM is assumed.
       ...
       --compressed
              ...
              rithms curl supports, and save the uncompressed  document.   If
              this  option is used and the server sends an unsupported encod‐
       ...
       -K, --config <file>
              ...
              in  the  file,  separated  by  whitespace, colon, or the equals
              ...
              If the parameter is to contain whitespace, the  parameter  must
              be  enclosed within quotes. Within double quotes, the following
              escape sequences are available: \\, \", \t, \n, \r  and  \v.  A
              backslash  preceding  any other letter is ignored. If the first
              column of a config line is a '#' character,  the  rest  of  the
              ...
              the home dir given the current user in your  system).  On  Win‐
              dows,  it  then  checks  for the APPDATA variable, or as a last
       ...
       --connect-to <HOST1:PORT1:HOST2:PORT2>
              ...
              may also be the empty string, meaning "use the request's origi‐
              nal host/port".
       ...
       -c, --cookie-jar <filename>
              ...
              you  set  the file name to a single dash, "-", the cookies will
       ...
       -b, --cookie <data>
              ...
              as  a  filename  to  read  previously  stored cookie from. This
              option also activates the cookie engine which  will  make  curl
              record  incoming  cookies,  which  may be handy if you're using
              ...
              in a file use the Set-Cookie format and don't specify a domain,
              then the cookie is sent for any domain  (even  after  redirects
              are followed) and cannot be modified by a server-set cookie. If
              the cookie engine is enabled and a server sets a cookie of  the
              same  name  then both will be sent on a future transfer to that
              server, likely not what you intended.  To address these  issues
              set  a  domain  in  Set-Cookie  (doing  that  will  include sub
              ...
              --cookie  and -c, --cookie-jar in the same command line is com‐
              mon.
       ...
       --crlfile <file>
              (TLS) Provide a file using PEM format with a Certificate  Revo‐
              cation  List  that may specify peer certificates that are to be
              considered revoked.
       ...
       -d, --data <data>
              ...
              cause curl to pass the data to the server  using  the  content-
              ...
              Posting  data from a file named from a file like that, carriage
              returns and newlines will be stripped out. If  you  don't  want
              the @ character to have a special interpretation use --data-raw
              instead.

              See also --data-binary  and  --data-urlencode  and  --data-raw.
              This option overrides -F, --form and -I, --head and --upload.
       ...
       --engine <name>
              ...
              ported  engines. Note that not all (or none) of the engines may
              be available at run-time.

       --expect100-timeout <seconds>
              (HTTP) Maximum time in seconds that you allow curl to wait  for
              a  100-continue  response  when curl emits an Expects: 100-con‐
              tinue header in its request. By default curl will wait one sec‐
              ond.  This option accepts decimal values! When curl stops wait‐
              ing, it will continue as if the response has been received.
       ...
       --false-start
              ...
              application  data  before  verifying the server's Finished mes‐
              sage, thus saving a round trip when  performing  a  full  hand‐
              shake.
       ...
       -F, --form <name=content>
              ...
              the < makes a text field and just get  the  contents  for  that
              ...
              filename. This goes for both @ and < constructs.  If  stdin  is
              not  attached to a regular file, it is buffered first to deter‐
              mine its size and allow a possible resend.  Defining  a  part's
              ...
              unknown before the transfer starts, data is sent as  chunks  by
              ...
              starting the continuation line with a space; embedded carriage-
              returns  and  trailing spaces are stripped.  Here is an example
              ...
              sisting in an inline part in  two  alternative  formats:  plain
       ...
       --ftp-create-dirs
              ...
              curl is to fail. Using this option, curl will  instead  attempt
       ...
       -P, --ftp-port <address>
              ...
              address  and  port, while passive mode asks the server to setup
              an IP address and port for it to connect to.  <address>  should
              be one of:
       ...
       --ftp-ssl-ccc-mode <active/passive>
              ...
              shutdown, but instead wait for the server to do  it,  and  will
       ...
       -G, --get
              ...
              used.  The  data will be appended to the URL with a '?' separa‐
              tor.
       ...
       -H, --header <header/@file>
              ...
              as one of the internal ones curl would use, your externally set
              header will be used instead of the internal  one.  This  allows
              you  to  make  even trickier stuff than curl would normally do.
              You should not replace internally set headers  without  knowing
              ...
              no-value then its header must be terminated with  a  semicolon,
       ...
       --http2
              ...
              See  also  --no-alpn.  --http2  requires  that  the  underlying
       ...
       --keepalive-time <seconds>
              ...
              keepalive  probes.  It is currently effective on operating sys‐
              tems offering the TCP_KEEPIDLE and TCP_KEEPINTVL socket options
       ...
       --key <key>
              ...
              curl tries the following candidates in order:
       ...
       -l, --list-only
              ...
              the  normal  directory view doesn't use a standard look or for‐
              mat. When used like this, the option causes a NLST  command  to
              ...
              to send an UIDL command  instead,  so  the  user  may  use  the
       ...
       --local-port <num/range>
              ...
              setting this range to something too narrow might cause unneces‐
              sary connection setup failures.
       ...
       -L, --location
              ...
              (for example POST or PUT), it will  do  the  following  request
       ...
       --metalink
              ...
              included  in  the  file  described in Metalink file, hash check
              will fail.
       ...
       --negotiate
              ...
              See  also  --basic and --ntlm and --anyauth and --proxy-negoti‐
              ate.

       --netrc-file <filename>
              This option is similar to -n, --netrc, except that you  provide
              the  path  (absolute  or  relative) to the netrc file that Curl
              should use.  You can only specify one netrc  file  per  invoca‐
              tion.  If  several  --netrc-file options are provided, the last
              one will be used.
       ...
       -n, --netrc
              ...
              user's home directory for login name and password. This is typ‐
              ically used for FTP on Unix.  If  used  with  HTTP,  curl  will
       ...
       --no-npn
              ...
              default if libcurl was built with an SSL library that  supports
              NPN. NPN is used by a libcurl that supports HTTP/2 to negotiate
       ...
       --no-sessionid
              ...
              there seem to be broken SSL implementations in  the  wild  that
       ...
       --ntlm-wb
              ...
              over  the authentication to the separate binary ntlmauth appli‐
              cation that is executed when needed.
       ...
       --ntlm (HTTP) Enables NTLM  authentication.  The  NTLM  authentication
              ...
              umented authentication method instead, such as Digest.
       ...
       --oauth2-bearer <token>
              ...
              authentication.  The  Bearer  Token is used in conjunction with
              the user name which can be specified as part of  the  --url  or
              -u, --user options.
       ...
       --pinnedpubkey <hashes>
              ...
              contains  a single public key in PEM or DER format, or any num‐
              ber of base64 encoded sha256 hashes preceded by ´sha256//´  and
              separated by ´;´
       ...
       --post301
              ...
              However, a server may require a POST to  remain  a  POST  after
              such  a  redirection. This option is meaningful only when using
              -L, --location.
       ...
       --post303
              (HTTP) Tells curl to respect RFC  7231/6.4.4  and  not  convert
       ...
       -#, --progress-bar
              ...
              known. For transfers without a known size, it will instead out‐
       ...
       --proto-redir <protocols>
              ...
              By default curl will allow all  protocols  on  redirect  except
              several  disabled  for  security reasons: Since 7.19.4 FILE and
              SCP are disabled, and since 7.40.0 SMB and SMBS are  also  dis‐
              abled.  Specifying  all  or +all enables all protocols on redi‐
              rect, including those disabled for security.
       ...
       --proxy-header <header/@file>
              (HTTP) Extra header to include in the request when sending HTTP
              to a proxy. You may specify any number of extra  headers.  This
              is  the equivalent option to -H, --header but is for proxy com‐
              munication only like in CONNECT requests when you want a  sepa‐
              rate  header  sent  to  the proxy to what is sent to the actual
              remote host.
       ...
       -x, --proxy [protocol://]host[:port]
              ...
              protocol specified or http:// will be treated  as  HTTP  proxy.
              ...
              transparently be converted to HTTP. It means that certain  pro‐
              tocol  specific  operations might not be available. This is not
       ...
       --pubkey <key>
              ...
              (As  of 7.39.0, curl attempts to automatically extract the pub‐
              lic key from the private key file, so passing  this  option  is
              generally  not  required.  Note that this public key extraction
              requires libcurl to be linked against a copy of  libssh2  1.2.8
       ...
       -Q, --quote
              ...
              exact). To make commands take place after a  successful  trans‐
              fer,  prefix  them  with  a dash '-'.  To make commands be sent
              after curl has changed the working directory, just  before  the
              transfer  command(s),  prefix  the  command with a '+' (this is
              only supported for FTP). You may specify  any  number  of  com‐
              mands.
              ...
              chgrp group file
                     ...
                     operand.  The  group  operand is a decimal integer group
                     ID.
       ...
       --random-file <file>
              Specify the path name to file containing what will  be  consid‐
              ered  as  random  data. The data may be used to seed the random
       ...
       -r, --range <range>
              ...
              ter  is  given  in  the  range,  the  server's response will be
       ...
       -J, --remote-header-name
              ...
              file name, so this option may provide  you  with  rather  unex‐
              pected file names.
       ...
       --remote-name-all
              ...
              dealt  with  as if -O, --remote-name were used for each one. So
              if you want to disable that for a specific URL after  --remote-
              name-all  has  been  used,  you must use "-o -" or --no-remote-
              name.
       ...
       -X, --request <command>
              (HTTP)  Specifies  a custom request method to use when communi‐
              cating with the HTTP server.  The specified request method will
              be used instead of the method otherwise used (which defaults to
              GET). Read the HTTP 1.1 specification for details and  explana‐
              tions.  Common additional HTTP requests include PUT and DELETE,
              but related technologies like  WebDAV  offers  PROPFIND,  COPY,
              MOVE and more.
       ...
       --socks4 <host[:port]>
              Use the specified SOCKS4 proxy. If the port number is not spec‐
              ...
              a socks4 proxy with -x, --proxy using a socks4:// protocol pre‐
              fix.
       ...
       --socks5-basic
              Tells  curl  to  use username/password authentication when con‐
              necting to a SOCKS5 proxy.  The  username/password  authentica‐
              tion  is enabled by default.  Use --socks5-gssapi to force GSS-
              API authentication to SOCKS5 proxies.
       ...
       --socks5 <host[:port]>
              ...
              Since  7.21.7, this option is superfluous since you can specify
              a socks5 proxy with -x, --proxy using a socks5:// protocol pre‐
              fix.
       ...
       --ssl-no-revoke
              ...
              tion  checks.   WARNING:  this option loosens the SSL security,
              and by using this flag you ask for exactly that.

              Added in 7.44.0.

       --ssl-reqd
              (FTP IMAP POP3 SMTP) Require SSL/TLS for the connection.   Ter‐
       ...
       --ssl  (FTP  IMAP  POP3  SMTP)  Try to use SSL/TLS for the connection.
              Reverts to a non-secure connection if the server  doesn't  sup‐
       ...
       --suppress-connect-headers
              ...
              See  also  -D, --dump-header and -i, --include and -p, --proxy‐
              tunnel.
       ...
       -z, --time-cond <time>
              ...
              if it doesn't match any internal ones, it is taken as  a  file‐
       ...
       See  also  --tlsv1.0  and  --tlsv1.1 and --tlsv1.2. --tls-max requires
       that the underlying libcurl was built to support TLS. Added in 7.54.0.
       ...
       --tlsv1.3
              ...
              Note that TLS 1.3 is only supported by a subset  of  TLS  back‐
              ends. At the time of this writing, they are BoringSSL, NSS, and
              Secure Transport (on iOS  11  or  later,  and  macOS  10.13  or
              later).
       ...
       -T, --upload-file <file>
              ...
              operation  to  fail.  If this is used on an HTTP(S) server, the
       ...
       --url <url>
              ...
              will  be used. Since 7.45.0 guessing can be disabled by setting
       ...
       -B, --use-ascii
              ...
              causes data sent to stdout to be in text mode  for  win32  sys‐
              tems.
       ...
       -u, --user <user:password>
              Specify  the user name and password to use for server authenti‐
       ...
       -V, --version
              ...
              Metalink
                     ...
                     use  mirrors  for  failover if there are errors (such as
       ...
       -w, --write-out <format>
              ...
              as  a  literal  "string",  or you can have curl read the format
              from a file with "@filename" and to tell curl to read the  for‐
              mat from stdin you write "@-".
              ...
              proxy_ssl_verify_result
                             The  result  of  the HTTPS proxy's SSL peer cer‐
                             tificate  verification  that  was  requested.  0
              ...
              redirect_url   When  an  HTTP  request  was  made  without  -L,
                             ...
                             actual URL a redirect would have gone to. (Added
                             in 7.18.2)
              ...
              ssl_verify_result
                             ...
                             tion  that  was requested. 0 means the verifica‐
              ...
              time_redirect  The  time, in seconds, it took for all redirect‐
                             ion steps including name lookup,  connect,  pre‐
                             transfer  and transfer before the final transac‐
                             tion was started. time_redirect shows  the  com‐
                             plete  execution time for multiple redirections.
                             (Added in 7.12.3)
       ...
       --xattr
              ...
              HTTP, the content type is stored in the mime_type attribute. If
              the file system does not support extended attributes, a warning
              is issued.
...
ENVIRONMENT
       ...
       case. The lower case version has precedence. http_proxy is  an  excep‐
       tion as it is only available in lower case.
...
PROXY PROTOCOL PREFIXES
       ...
       http://
              Makes  it use it as a HTTP proxy. The default if no scheme pre‐
              fix is used.
