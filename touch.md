...
DESCRIPTION
       ...
       --time=WORD
              change  the specified time: WORD is access, atime, or use: equivalent to -a WORD is mod‐
              ify or mtime: equivalent to -m
...
DATE STRING
       ...
       is more complex than is easily documented here but is fully described in  the  info  documenta‐
       tion.
