...
DESCRIPTION
       ...
       tems.   The  only  exception is if the -n option is specified, and -c,
       -l, or -L options are not specified.   However, even if it is safe  to
       do  so,  the results printed by e2fsck are not valid if the filesystem
       ...
       response, which is printed before the question  mark.   Pressing  Con‐
       trol-C terminates e2fsck immediately.
...
OPTIONS
       ...
       -b superblock
              ...
              tion of backup superblocks is  dependent  on  the  filesystem's
       ...
       -C fd  This  option  causes  e2fsck to write completion information to
              ...
              e2fsck process a SIGUSR1 signal.  If the file descriptor speci‐
       ...
       -D     Optimize directories in filesystem.  This option causes  e2fsck
              ...
              indexed,  or  if the index structures are corrupted and need to
              be rebuilt.  The  -D  option  forces  all  directories  in  the
              filesystem  to  be  optimized.   This can sometimes make them a
              little smaller and slightly faster to search, but in  practice,
       ...
       -E extended_options
              ...
              The following options are supported:
                   ...
                   discard
                          ...
                          checked  and  only if it does not contain recogniz‐
                          able errors. However there  might  be  cases  where
                          e2fsck does not fully recognize a problem and hence
                          in this case this option may prevent you from  fur‐
                          ther manual data recovery.
                   ...
                   no_optimize_extents
                          ...
                          nating unnecessary width or depth.  This  can  also
                          be    enabled    in    the   options   section   of
                          /etc/e2fsck.conf.
                   ...
                   inode_count_fullmap
                          ...
                          memory  if  this  optimization  is  enabled.)  This
                          optimization can also be  enabled  in  the  options
                   ...
                   readahead_kb
                          ...
                          1/50th of total physical memory, readahead is  dis‐
                          abled.   Set  this  to  zero  to  disable readahead
                          entirely.
       ...
       -y     Assume an answer of `yes' to all questions; allows e2fsck to be
              used non-interactively.  This option may not  be  specified  at
              the same time as the -n or -p options.
...
REPORTING BUGS
       ...
       most useful data you can send to help reproduce  the  bug  is  a  com‐
       pressed  raw image dump of the filesystem, generated using e2image(8).
