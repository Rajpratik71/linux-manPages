...
DESCRIPTION
       ...
       Note:  some  shells  (e.g.,  bash(1)) have a built-in time command that provides less functionality than the command described here.  To access the real command, you may need to specify its pathname
