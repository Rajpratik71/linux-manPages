...
DESCRIPTION
       The  gettext program translates a natural language message into the user's language, by looking
       ...
       tion the program behaves like the 'echo' command.  But it does not simply copy its arguments to
       stdout.  Instead those messages found in the selected catalog are translated.  Standard  search
