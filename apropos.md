...
OPTIONS
       ...
       -r, --regex
              ...
              any  part  of  either.  The match is not limited to word bound‐
              aries.
       ...
       -M path, --manpath=path
              ...
              chies  to  search.  By default, apropos uses the $MANPATH envi‐
              ronment variable, unless it is empty or unset, in which case it
       ...
       -L locale, --locale=locale
              ...
              to the C function setlocale(3) which interrogates various envi‐
              ronment  variables,  possibly including $LC_MESSAGES and $LANG.
              To temporarily override the determined value, use  this  option
              to  supply  a  locale string directly to apropos.  Note that it
              will not take  effect  until  the  search  for  pages  actually
              begins.   Output  such  as the help message will always be dis‐
