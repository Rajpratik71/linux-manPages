...
DESCRIPTION
       Checks  dependency  versions,permissions  of  HPLIP.  (Run  as 'python
...
NOTES
       1.  For  checking  for the proper build environment for the HPLIP sup‐
       plied tarball (.tar.gz or .run),
