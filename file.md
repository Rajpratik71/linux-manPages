...
OPTIONS
     --apple
             ...
             ters, the first describing the file type, the latter the cre‐
             ator.
     ...
     -f, --files-from namefile
             ...
             one filename argument must be present; to test the standard
             input, use ‘-’ as a filename argument.  Please note that
     ...
     -l, --list
             ...
             magic(4) strength which is used for the matching (see also the
             -k option).
     ...
     -s, --special-files
             ...
             option also causes file to disregard the file size as reported
             by stat(2) since on some systems it reports a zero size for raw
             disk partitions.
...
ENVIRONMENT
     ...
     ered.  The environment variable POSIXLY_CORRECT controls (on systems
