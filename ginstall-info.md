...
OPTIONS
       ...
       --section=SEC
              put  entries in section SEC of the directory.  If you specify more than one section, all
              the entries
       ...
       from information in the Info file itself;
              if nothing is available there, the --defsection value is used; if that is not specified,
              the final default is "Miscellaneous".
...
SEE ALSO
       The full documentation for install-info is maintained as a Texinfo manual.  If the info and in‐
       stall-info programs are properly installed at your site, the command
