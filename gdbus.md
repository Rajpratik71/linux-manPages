...
SYNOPSIS
       ...
       gdbus wait [--system | --session | --address address] --activate bus_name [--timeout seconds]
             bus_name
...
COMMANDS
       ...
       wait
           Waits until bus_name is owned by some process on the bus. If the --activate is specified,
...
BASH COMPLETION
       gdbus ships with a bash completion script to complete commands, destinations, bus names, object
       paths and interface/method names.
