...
DESCRIPTION
       foo2slx-wrapper  is a Foomatic compatible printer wrapper for the foo2slx printer driver.  This
       script reads a Postscript ps-file or standard input and converts it to  Software  Imaging  K.K.
       SLX printer format for driving the Lexmark C500 network color laser printer and other SLX-based
       printers.
...
COMMAND LINE OPTIONS
   ...
   Printer Tweaking Options
       ...
       -L mask
              Send the logical clipping values from -u/-l in  the  ZjStream.   foo2slx-wrapper  always
