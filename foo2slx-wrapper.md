...
COMMAND LINE OPTIONS
   ...
   Printer Tweaking Options
       ...
       -L mask
              Send  the logical clipping values from -u/-l in the ZjStream.  foo2slx-wrapper always runs Ghostscript with the ideal page dimensions, so that the scale of the image is correct, regardless whether or not the printer has unprintable regions.  This option is used to move the position of the clipped
