...
DESCRIPTION
       aspell-import  is  a command that will search for old personal dictio‐
       naries and will import them into GNU Aspell. It  will  look  for  both
       Ispell and Aspell dictionaries. To use it just run it from the command
       prompt.
...
SEE ALSO
       ...
       The full documentation for Aspell is maintained as  a  Texinfo  manual
