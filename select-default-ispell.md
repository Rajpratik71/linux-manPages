...
DESCRIPTION
       ...
       If --set-default is not used this program will make debconf always ask the shared question about the default ispell dictionary to be used
       in your system according to the installed ones.
...
1.27.2~ubuntu16.04.1~c42.ppa1                                       2017-12-18                                            SELECT-DEFAULT-ISPELL(8)
