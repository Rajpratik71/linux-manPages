...
DESCRIPTION
   ...
   Password Changes
       ...
       is permitted to change the password at this time. If not, passwd refuses to change the password
       and exits.
   ...
   Hints for user passwords
       ...
       More recent methods are now recommended (see ENCRYPT_METHOD). The size of the key space depends
       ...
       For this reason, you should not select a password which appears in a dictionary or which must
       be written down. The password should also not be a proper name, your license number, birth
       date, or street address. Any of these may be used as guesses to violate system security.
...
OPTIONS
       ...
       -e, --expire
           Immediately expire an account's password. This in effect can force a user to change his/her
       ...
       -i, --inactive INACTIVE
           This option is used to disable an account after the password has been expired for a number
           of days. After a user account has had an expired password for INACTIVE days, the user may
       ...
       -n, --mindays MIN_DAYS
           ...
           this field indicates that the user may change his/her password at any time.
       ...
       -w, --warndays WARN_DAYS
           ...
           option is the number of days prior to the password expiring that a user will be warned that
...
CAVEATS
       Password complexity checking may vary from site to site. The user is urged to select a password
       as complex as he or she feels comfortable with.
...
shadow-utils 4.5                              08/29/2019                                     PASSWD(1)
