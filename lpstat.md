...
OPTIONS
       ...
       -W which-jobs
            ...
            default).   This  option  must appear before the -o option and/or
            any printer names, otherwise the default ("not-completed")  value
       ...
       -o [destination(s)]
            Shows  the jobs queued on the specified destinations.  If no des‐
            tinations are specified all jobs are shown.
