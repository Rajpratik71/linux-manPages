...
OPTIONS
       ...
       --no-warn-deprecated
              Do not warn about usage of deprecated items that  were  defined
              in previous versions of the specification.

       --warn-kde
              Warn  about  usage of KDE extensions to the specification. This
              includes the use of the KDE Desktop Entry group,  of  the  Ser‐
              viceTypes,  DocPath,  Keywords, InitialPreference, Dev, FSType,
              MountPoint, ReadOnly, UnmountIcon keys, or of the Service, Ser‐
              viceType and FSDevice types.
