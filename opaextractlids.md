...
NAME
       ...
       Produces  a  CSV  file  listing  all or some of the LIDs in the fabric. opaextractlids is a front end to the opareport tool. The output from this tool can be imported into a spreadsheet or parsed by
       other scripts.
