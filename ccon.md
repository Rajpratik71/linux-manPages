CCON(1p)                                                User Contributed Perl Documentation                                               CCON(1p)

NAME
       ccon - Cluster administration tool

SYNOPSIS
       ccon [-K <seconds>] [-q] [-c '<filename>'] [-C '<filename>'] [--debug [[...] || <INTEGER>]] [-d] [-e '<[user@]<host>[:port]>'] [-f
       '<font>'] [-h] [-L '[tag]'] [-H] [-M '<STRING>'] [-p <port>] [-Q] [-s] [-r '<filename>'] [-t '<STRING>'] [-g] [-T '<title>'] [-u] [-?] [-A]
       [-v]
...
DESCRIPTION
       ...
       Connections are opened using console which must be correctly installed and configured.
...
perl v5.20.2                                                        2015-12-04                                                            CCON(1p)
