...
DESCRIPTION
       ...
       and the offsets of their basic signatures.  The default output is sub‐
       ject to change.  So whenever possible, you should avoid using  default
       ...
       When option -a is used, all magic strings that are  visible  for  lib‐
       blkid are erased. In this case the wipefs scans the device again after
