...
SEE ALSO
       The full documentation for grub-mount is maintained as a Texinfo manual.  If the info and grub-
       mount programs are properly installed at your site, the command

              info grub-mount

       should give you access to the complete manual.

grub-mount (GRUB) 2.04-1ubuntu12.1           November 2019                               GRUB-MOUNT(1)
