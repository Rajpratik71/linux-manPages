UNICHARSET_EXTRACTOR(1)                                                       UNICHARSET_EXTRACTOR(1)
...
DESCRIPTION
       ...
       unicharset data file, use the unicharset_extractor program on the same training pages bounding
       box files as used for clustering:

           unicharset_extractor fontfile_1.box fontfile_2.box ...

       The unicharset will be put into the file dir/unicharset, or simply ./unicharset if no output
       ...
       unicharset_extractor and there is no need to edit the unicharset file. On some older systems
       (eg Windows 95), the unicharset file must be edited by hand to add these property description
       codes.

       NOTE The unicharset file must be regenerated whenever inttemp, normproto and pffmtable are
       generated (i.e. they must all be recreated when the box file is changed) as they have to be in
       sync. This is made easier than in previous versions by running unicharset_extractor before
...
AUTHOR
       ...
       (1985-1995) and Google (2006-present).
                                              ...
                                              04/07/2018                      UNICHARSET_EXTRACTOR(1)
