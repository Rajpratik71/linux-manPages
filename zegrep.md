...
DESCRIPTION
       ...
       to grep.  If no file is specified, then the standard input is decompressed if necessary and fed
...
BUGS
       ...
       --exclude, --exclude-from, --exclude-dir, --include, --null (-Z), --null-data (-z),  and  --re‐
       cursive (-r).
