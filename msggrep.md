...
DESCRIPTION
   ...
   Message selection:
       ...
       one of the specified domains, or if -J is given and its context (msgctxt) matches  MSGCTXT-PAT‐
       TERN,  or if -K is given and its key (msgid or msgid_plural) matches MSGID-PATTERN, or if -T is
       given and its translation (msgstr) matches MSGSTR-PATTERN, or if -C is given and  the  transla‐
       tor's  comment matches COMMENT-PATTERN, or if -X is given and the extracted comment matches EX‐
       TRACTED-COMMENT-PATTERN.

       When more than one selection criterion is specified, the set of selected messages is the  union
       of the selected messages of each criterion.

       MSGCTXT-PATTERN or MSGID-PATTERN or MSGSTR-PATTERN or COMMENT-PATTERN or EXTRACTED-COMMENT-PAT‐
       TERN syntax:
...
COPYRIGHT
       Copyright © 2001-2016 Free Software Foundation, Inc.  License GPLv3+:  GNU  GPL  version  3  or
