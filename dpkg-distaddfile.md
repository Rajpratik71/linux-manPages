...
DESCRIPTION
       ...
       The  filename  should be specified relative to the directory where dpkg-genchanges will expect to find the files, usually .., rather than being a pathname relative to the current
...
1.19.2                                                                                  2018-10-19                                                                    dpkg-distaddfile(1)
