...
NAME
       import  - saves any visible window on an X server and outputs it as an image file. You can cap‐
       ture a single window, the entire screen, or any rectangular portion of the screen.
...
DESCRIPTION
       ...
       the  image type as the filename suffix (i.e. image.ps).  Specify 'file' as '-' for standard in‐
       put or output.
