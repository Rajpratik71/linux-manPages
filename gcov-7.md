...
DESCRIPTION
       ...
       code and to discover untested parts of your program.  You can use gcov
       as a profiling tool to help discover where your optimization efforts
       will best affect your code.  You can also use gcov along with the
       other profiling tool, gprof, to assess which parts of your code use
       ...
       *   how much computing time each section of code uses
       ...
       If your complex macros behave like functions, you can replace them
...
OPTIONS
       ...
       --source-prefix directory
           ...
           not wanted when determining the output file names.  Note that this
           prefix detection is applied before determining whether the source
           file is absolute.
       ...
       --hash-filenames
           ...
           form source-file##md5.gcov, where the source-file component is the
           final filename part and the md5 component is calculated from the
       ...
       values are exactly 0% and 100% respectively.  Other values which would
       ...
       to contain code, unless previous blocks end on those lines.  The total
   ...
   Using gcov with GCC Optimization
       ...
       files.  Instrumented applications use a static destructor with
       priority 99 to invoke the "__gcov_dump" function. Thus "__gcov_dump"
       is executed after all user defined static destructors, as well as
       handlers registered with "atexit".  If an executable loads a dynamic
       shared object via dlopen functionality, -Wl,--dynamic-list-data is
