...
DESCRIPTION
       ...
       outfile.  An input file name of "-" denotes  standard  input,  and  an
...
TABLE FILE FORMAT
       ...
       codes  matched  by this specific glyph slot.  Instead of a single Uni‐
       code one may have a sequence  of  Unicodes  separates  by  commas,  to
       denote  that  the glyph depicts the corresponding composed symbol.  It
       is permissible to have multiple lines for the same glyph.
