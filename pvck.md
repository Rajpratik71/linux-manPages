...
EXAMPLES
       If the partition table is corrupted or lost on /dev/sda, and you suspect there was an LVM  par‐
       tition  at  approximately 100 MiB, then this area of the disk can be scanned using the --label‐
       sector parameter with a value of 204800 (100 * 1024 * 1024 / 512 = 204800).
