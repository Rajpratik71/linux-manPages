...
DESCRIPTION
       ...
       This is similar to just redirecting output to a file using traditional shell syntax, but gvfs-save allows using gvfs locations instead of
       local files: for example you can use something like smb://server/resource/file.txt as location.
...
OPTIONS
       ...
       -u, --unlink
           When replacing an existing file, replace the destination as if it does not exist. Think of it as unlinking the destination before
           writing.
