...
DESCRIPTION
       ...
       vgs(8)  is  a preferred alternative that shows the same information and more, using a more com‐
...
OPTIONS
       -A|--activevolumegroups
              Only select active VGs. The VG is considered active if at least one of its LVs is ac‐
              tive.
