...
DESCRIPTION
       apt-mark can be used as a unified front-end to set various settings
       for a package, such as marking a package as being
...
AUTOMATICALLY AND MANUALLY INSTALLED PACKAGES
       ...
       manual
           manual is used to mark a package as being manually installed,
   ...
   Options
       -f=filename, --file=filename
           ...
           extended_status in the directory defined by the Configuration
           Item: Dir::State.
