...
OPTIONS
       ...
       -n name, --name=name
           ...
           If it is, a path like ".../lib/Pod/Man.pm" is converted into a name like "Pod::Man".  This
           ...
           man pages for commands is for the man page title to be in all-uppercase, even if the
           command isn't.
       ...
       --nourls
           ...
           formatted as just "foo".  This can produce less cluttered output in cases where the URLs
       ...
       -q quotes, --quotes=quotes
           Sets the quote marks used to surround C<> text to quotes.  If quotes is a single character,
           it is used as both the left and right quote.  Otherwise, it is split in half, and the first
       ...
       -r version, --release=version
           ...
           *roff implementations to use the system default value.
           ...
           for your target system, you may want to set --release to the last modified date and --date
           to the version number.

       -s string, --section=string
           Set the section for the ".TH" macro.  The standard section numbering convention is to use 1
           for user commands, 2 for system calls, 3 for functions, 4 for devices, 5 for file formats,
           6 for games, 7 for miscellaneous information, and 8 for administrator commands.  There is a
           lot of variation here, however; some systems (like Solaris) use 4 for file formats, 5 for
           miscellaneous information, and 7 for devices.  Still others use 1m instead of 8, or some
           mix of both.  About the only section numbers that are reliably consistent are 1, 2, and 3.
       ...
       --stderr
           ...
           abort.  This is equivalent to "--errors=stderr" and is supported for backward
           compatibility.
...
EXIT STATUS
       ...
       handling style is set to the default of "die", pod2man will abort immediately with exit status
       255.
...
COPYRIGHT AND LICENSE
       Copyright 1999, 2000, 2001, 2004, 2006, 2008, 2010, 2012, 2013, 2014, 2015, 2016, 2017 Russ
