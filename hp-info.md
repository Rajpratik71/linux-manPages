...
DESCRIPTION
       Query  a printer for static model information, dynamic status informa‐
       tion, and CUPS printer queue settings.
...
OPTIONS
       ...
       Device ID mode:
              --id  (prints device ID only and exits.) (interactive (-i) mode
              only.)
