...
DESCRIPTION
       The sg command works similar to newgrp but accepts a command. The command will be executed with
       the /bin/sh shell. With most shells you may run sg from, you need to enclose multi-word
       ...
       doesn't happen with sg, so upon exit from a sg command you are returned to your previous group
       ID.
