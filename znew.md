...
DESCRIPTION
       Znew  recompresses  files from .Z (compress) format to .gz (gzip) for‐
...
SEE ALSO
       gzip(1),  zmore(1),  zdiff(1),  zgrep(1),  zforce(1),  gzexe(1),  com‐
       press(1)

BUGS
       Znew  does  not maintain the time stamp with the -P option if cpmod(1)
