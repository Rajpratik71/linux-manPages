...
OPTIONS
       ...
       --update-section sectionname=filename
           ...
           to both update and rename a section from one command line.  In
           this case, pass the original section name to --update-section, and
       ...
       --long-section-names {enable,disable,keep}
           ...
           any are present in the inputs; this is mostly the same as keep,
           but it is left undefined whether the enable option might force the
