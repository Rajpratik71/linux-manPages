...
DESCRIPTION
       ...
       (o),  or  all  users  (a).  If none of these are given, the effect is as if (a) were given, but
       ...
       cute (1); the third selects permissions for other users in the file's group, with the same val‐
       ...
       sions of the pointed-to file.  In contrast, chmod ignores symbolic links encountered during re‐
       cursive directory traversals.
...
SETUID AND SETGID BITS
       ...
       bits for directories with a numeric mode requires an additional leading zero, or leading = like
       00755 , or =755
...
RESTRICTED DELETION FLAG OR STICKY BIT
       ...
       flag for the directory, and is commonly found on world-writable  directories  like  /tmp.   For
       regular  files on some older systems, the bit saves the program's text image on the swap device
