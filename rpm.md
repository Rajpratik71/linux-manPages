...
DESCRIPTION
   ...
   PACKAGE SELECTION OPTIONS:
       ...
       -p, --package PACKAGE_FILE
              ...
              OPTIONS for information on rpm's internal ftp and http client support. The PACKAGE_FILE argument(s), if not a binary package, will be interpreted as an ASCII package manifest unless --nomani-
       ...
       --whatrequires CAPABILITY
              ...
              Note  that  this does not return what requires a given package.  A package usually provides multiple capabilities and file-names on which other packages may depend. To see the complete depen-
              dencies for a package, use -e --test PACKAGE_NAME
