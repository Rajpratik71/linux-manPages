...
ARGUMENTS
       ...
       htmldir
           ...
           Sets the directory to which all cross references in the resulting HTML file will be relative. Not passing this causes all links to be absolute since this is the value that
...
perl v5.28.0                                                                            2018-10-31                                                                            POD2HTML(1)
