...
UPDATE HOOK
       ...
       the ref will actually be updated, it is only a prerequisite. As such
       it is not a good idea to send notices (e.g. email) from this hook.
...
QUARANTINE ENVIRONMENT
       ...
       This has a few user-visible effects and caveats:
        ...
        1. Pushes which fail due to problems with the incoming pack, missing
           ...
           from filling up your disk, but can make debugging more
           challenging.
