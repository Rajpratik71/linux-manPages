...
OPTIONS
       Xkbwatch accepts all of the standard X Toolkit command line options along with  the  additional
       options listed below:

       -version
               This  option indicates that the program version should be printed, after which the pro‐
               gram exits.
