...
DESCRIPTION
       ...
       able  sections  following a pre-defined order ("1 n l 8 3 2 3posix 3pm
       3perl 3am 5 4 9 6 7" by default,  unless  overridden  by  the  SECTION
       directive  in  /etc/manpath.config),  and  to show only the first page
...
OPTIONS
   ...
   Controlling formatted output
       ...
       -r prompt, --prompt=prompt
              ...
              to  set a default prompt string if none is supplied on the com‐
              mand line.
...
ENVIRONMENT
       ...
       MANPAGER, PAGER
              ...
              display  the  manual  page.  By default, pager is used, falling
              back to cat if pager is not found or is not executable.
       ...
       MANLESS
              ...
              will be expanded in the same way).  For example, if you want to
              set  the  prompt  string unconditionally to “my prompt string”,
              set $MANLESS to ‘-Psmy prompt string’.   Using  the  -r  option
       ...
       MANOPT If  $MANOPT  is  set,  it will be parsed prior to man's command
              ...
              lete.  N.B.  All spaces that should be interpreted as  part  of
