...
TARGETS
       ...
       does match, then the next rule is specified by the value of  the  tar‐
       get, which can be the name of a user-defined chain, one of the targets
       ...
       in chain is reached or a rule in a built-in chain with  target  RETURN
...
TABLES
       ...
       -t, --table table
              ...
              raw:
                  ...
                  It  registers  at  the netfilter hooks with higher priority
                  and is thus called before ip_conntrack,  or  any  other  IP
                  tables.   It  provides  the following built-in chains: PRE‐
                  ROUTING (for packets arriving via  any  network  interface)
              ...
              security:
                  ...
                  mented by Linux Security  Modules  such  as  SELinux.   The
                  ...
                  into  the  box itself), OUTPUT (for altering locally-gener‐
                  ated packets before routing),  and  FORWARD  (for  altering
...
OPTIONS
   ...
   COMMANDS
       ...
       -S, --list-rules [chain]
              ...
              selected, all chains are printed like iptables-save. Like every
              other iptables command, it applies to the specified table (fil‐
              ter is the default).
   ...
   PARAMETERS
       ...
       -4, --ipv4
              ...
              will  throw an error. This option allows IPv4 and IPv6 rules in
              a single rule file  for  use  with  both  iptables-restore  and
              ip6tables-restore.
       ...
       [!] -p, --protocol protocol
              ...
              fied   protocol   can  be  one  of  tcp,  udp,  udplite,  icmp,
              ...
              sion 2.6.11 or later.  The number zero is  equivalent  to  all,
       ...
       [!] -s, --source address[/mask][,...]
              ...
              iptables)  or  a  plain number, specifying the number of 1's at
              the left side of the network mask.  Thus, an iptables  mask  of
              24  is  equivalent to 255.255.255.0.  A "!" argument before the
              address specification inverts the sense  of  the  address.  The
              flag --src is an alias for this option.  Multiple addresses can
       ...
       -m, --match match
              ...
              condition under which a target is invoked. Matches  are  evalu‐
              ated first to last as specified on the command line and work in
       ...
       -j, --jump target
              ...
              rule will have no effect on the packet's fate, but the counters
       ...
       [!] -f, --fragment
              ...
              will only match head fragments, or unfragmented  packets.  This
   ...
   OTHER OPTIONS
       ...
       -v, --verbose
              ...
              be specified multiple times  to  possibly  emit  more  detailed
              debug statements.

       -w, --wait [seconds]
              Wait  for  the  xtables lock.  To prevent multiple instances of
              the program from running concurrently, an attempt will be  made
              to obtain an exclusive lock at launch.  By default, the program
              will exit if the lock cannot be  obtained.   This  option  will
              make  the  program  wait (indefinitely or for optional seconds)
...
COMPATIBILITY WITH IPCHAINS
       ...
       extension modules.  This should simplify much of the  previous  confu‐
       sion over the combination of IP masquerading and packet filtering seen
