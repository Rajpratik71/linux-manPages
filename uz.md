...
DESCRIPTION
       uz  extracts a gzip'd tar'd archive, that is a tar(1) archive compressed with the gzip(1) util‐
       ity.  It is not strictly necessary on Debian GNU/Linux, because the GNU tar(1) program provides
