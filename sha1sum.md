...
DESCRIPTION
   ...
   The following five options are useful only when verifying checksums:
       ...
       The  sums are computed as described in FIPS-180-1.  When checking, the input should be a former output of this program.  The default mode is to print a line with checksum, a space, a character indi-
...
GNU coreutils 8.25                                                                               January 2016                                                                                      SHA1SUM(1)
