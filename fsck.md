...
OPTIONS
       ...
       -A     Walk through the /etc/fstab file and try to check all  filesys‐
              ...
              existing devices may  cause  the  system  to  enter  filesystem
...
FILESYSTEM SPECIFIC OPTIONS
       ...
       shouldn't be doing with fsck.  Options  to  different  filesystem-spe‐
...
ENVIRONMENT VARIABLES
       ...
       FSCK_MAX_INST
              ...
              might  overload  CPU and memory resources available on the sys‐
              tem.  If this value is zero, then an unlimited number  of  pro‐
              cesses  can  be  spawned.   This  is currently the default, but
