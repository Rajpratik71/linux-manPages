...
DESCRIPTION
       ...
       allows updating the comments in a zipfile as well as allows changing the names of the files  in
       the zipfile.  These modes are described below.
...
EXAMPLES
       ...
       The names of the files in the zipfile can also be changed in this way.  This is done by follow‐
       ing lines like
            "@ name"
...
BUGS
       The  temporary  file format is rather specific and zipnote is rather picky about it.  It should
