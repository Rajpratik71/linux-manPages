...
OPTIONS
       ...
       -v verbose
            Gives more detailed information about each test, after it has
            been performed.  Note that any failed tests ought to print out
            some extra information whether or not -v is thrown.
...
DIAGNOSTICS
       ...
       ·   print "# Required module '$_' does not appear to be properly
           ...
           An attempt to "eval "require $module"" failed, even though the
           list of extensions indicated that it should succeed.  Correct by
       ...
       consult the INSTALL file that comes with the perl source and the
       README file for your platform.
