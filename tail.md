...
DESCRIPTION
       ...
       tail'ed file is renamed, tail will continue to track its end.  This default behavior is not de‐
       sirable  when  you  really  want  to track the actual name of the file, not the file descriptor
