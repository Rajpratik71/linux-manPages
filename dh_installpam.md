...
OPTIONS
       --name=name
           Look for files named debian/package.name.pam and install them as etc/pam.d/name, instead of using the usual files and installing them
...
11.3.2ubuntu1ppa-xenial2                                            2018-07-25                                                    DH_INSTALLPAM(1)
