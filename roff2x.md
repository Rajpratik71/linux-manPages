...
DESCRIPTION
       roff2x transforms roff code into X mode corresponding to the groff devices X*; this mode is suitable for gxditview(1).  Print the result to
       standard output.
...
Groff Version 1.22.3                                              28 January 2016                                                        roff2x(1)
