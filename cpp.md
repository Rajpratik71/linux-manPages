...
DESCRIPTION
       ...
       lexical rules.  For example, apostrophes will be interpreted as the
       beginning of character constants, and cause errors.  Also, you cannot
       rely on it preserving characteristics of the input which are not
       significant to C-family languages.  If a Makefile is preprocessed, all
       the hard tabs will be removed, and the Makefile will not work.
       ...
       C, you should use the -std=c90, -std=c99 or -std=c11 options,
...
OPTIONS
       ...
       -ftrack-macro-expansion[=level]
           ...
           option. Value 1 tracks tokens locations in a degraded mode for the
           sake of minimal memory overhead. In this mode all tokens resulting
           from the expansion of an argument of a function-like macro have
           the same location. Value 2 tracks tokens locations completely.
           This value is the most memory hungry.  When this option is given
       ...
       -idirafter dir
           ...
           If dir begins with =, then the = is replaced by the sysroot
...
ENVIRONMENT
       ...
       SOURCE_DATE_EPOCH
           ...
           modification time of the source or package and it should be set by
           the build process.
