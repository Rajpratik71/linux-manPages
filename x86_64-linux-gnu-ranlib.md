...
OPTIONS
       ...
       -D  Operate in deterministic mode.  The symbol map archive member's header will show zero for
       ...
       -U  Do not operate in deterministic mode.  This is the inverse of the -D option, above: the
           archive index will get actual UID, GID, timestamp, and file mode values.

           If binutils was configured without --enable-deterministic-archives, then this mode is on by
           default.
