...
DESCRIPTION
       ...
       of each given file, and the files' group is not changed.  If the owner
       ...
       well.   If  a colon but no group name follows the user name, that user
       is made the owner of the files and the group of the files  is  changed
