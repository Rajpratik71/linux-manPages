...
DESCRIPTION
       ...
       --preserve[=ATTR_LIST]
              preserve the specified attributes (default: mode,ownership,timestamps), if possible  ad‐
              ditional attributes: context, links, xattr, all
       ...
       specified, fall back to a standard copy.  Use --reflink=never to ensure a standard copy is per‐
       formed.
