...
NAME
       compare  -  mathematically and visually annotate the difference between an image and its recon‐
       struction.
...
OVERVIEW
       The compare-im6.q16 program is a member of the ImageMagick-ims6.q16(1) suite of tools.  Use  it
       ...
       file:///usr/share/doc/imagemagick-6-common/html/www/compare.html (on debian system you may  in‐
       stall the imagemagick-6 package) or http://imagemagick.org/script/compare.php.
...
DESCRIPTION
       ...
       fuzz value is 0, with the exception of the normalized cross correlation metric (NCC), where two
       images are considered similar when their normalized cross correlation is 1. The default  metric
       is NCC.

       The compare program returns 2 on error, 0 if the images are similar, or a value between 0 and 1
...
COPYRIGHT
       ...
       system you may install the imagemagick-6 package) or http://imagemagick.org/script/license.php
