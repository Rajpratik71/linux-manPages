...
DESCRIPTION
       ...
       when the -h option is given. Unlike earlier versions, the BIND 9
...
OPTIONS
       ...
       -t type
           ...
           unless the -x option is supplied to indicate a reverse lookup. A
           zone transfer can be requested by specifying a type of AXFR. When
           an incremental zone transfer (IXFR) is required, set the type to
           ixfr=N. The incremental zone transfer will contain the changes
           made to the zone since the serial number in the zone's SOA record
           was N.
       ...
       -y [hmac:]keyname:secret
           ...
           hmac-sha384, or hmac-sha512. If hmac is not specified, the default
           is hmac-md5 or if MD5 was disabled hmac-sha256.
...
QUERY OPTIONS
       ...
       +bufsize=B
           ...
           appropriately. Values other than zero will cause a EDNS query to
           be sent.
       ...
       +[no]identify
           ...
           answers are requested, the default is not to show the source
       ...
       +[no]topdown
           ...
           validation. Requires dig be compiled with -DDIG_SIGCHASE. This
       ...
       +[no]trace
           ...
           name being looked up. It will follow referrals from the root
