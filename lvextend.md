...
DESCRIPTION
       lvextend extends the size of an LV. This requires allocating logical extents from the VG's free
       physical extents. If the extension adds a new LV segment, the new segment will use the existing
...
EXAMPLES
       ...
       Extend the size of an LV by the amount of free space on PV /dev/sdk3.  This  is  equivalent  to
